...
*/
    @JsonPropertyOrder({
        IndividualCreate.JSON_PROPERTY_ARISTOCRATIC_TITLE,
        IndividualCreate.JSON_PROPERTY_BIRTH_DATE,
        IndividualCreate.JSON_PROPERTY_COUNTRY_OF_BIRTH,
        IndividualCreate.JSON_PROPERTY_DEATH_DATE,
        IndividualCreate.JSON_PROPERTY_FAMILY_NAME,
        IndividualCreate.JSON_PROPERTY_FAMILY_NAME_PREFIX,
        IndividualCreate.JSON_PROPERTY_FORMATTED_NAME,
        IndividualCreate.JSON_PROPERTY_FULL_NAME,
        IndividualCreate.JSON_PROPERTY_GENDER,
        IndividualCreate.JSON_PROPERTY_GENERATION,
        IndividualCreate.JSON_PROPERTY_GIVEN_NAME,
        IndividualCreate.JSON_PROPERTY_LEGAL_NAME,
        IndividualCreate.JSON_PROPERTY_LOCATION,
        IndividualCreate.JSON_PROPERTY_MARITAL_STATUS,
        IndividualCreate.JSON_PROPERTY_MIDDLE_NAME,
        IndividualCreate.JSON_PROPERTY_NATIONALITY,
        IndividualCreate.JSON_PROPERTY_PLACE_OF_BIRTH,
        IndividualCreate.JSON_PROPERTY_PREFERRED_GIVEN_NAME,
        IndividualCreate.JSON_PROPERTY_TITLE,
        IndividualCreate.JSON_PROPERTY_CONTACT_MEDIUM,
        IndividualCreate.JSON_PROPERTY_CREDIT_RATING,
        IndividualCreate.JSON_PROPERTY_DISABILITY,
        IndividualCreate.JSON_PROPERTY_EXTERNAL_REFERENCE,
        IndividualCreate.JSON_PROPERTY_INDIVIDUAL_IDENTIFICATION,
        IndividualCreate.JSON_PROPERTY_LANGUAGE_ABILITY,
        IndividualCreate.JSON_PROPERTY_OTHER_NAME,
        IndividualCreate.JSON_PROPERTY_PARTY_CHARACTERISTIC,
        IndividualCreate.JSON_PROPERTY_RELATED_PARTY,
        IndividualCreate.JSON_PROPERTY_SKILL,
        IndividualCreate.JSON_PROPERTY_STATUS,
        IndividualCreate.JSON_PROPERTY_TAX_EXEMPTION_CERTIFICATE,
        IndividualCreate.JSON_PROPERTY_AT_BASE_TYPE,
        IndividualCreate.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        IndividualCreate.JSON_PROPERTY_AT_TYPE
    })
...
public class IndividualCreate implements Serializable {
