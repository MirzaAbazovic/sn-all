...
*/
    @JsonPropertyOrder({
        ResourceCandidateRef.JSON_PROPERTY_ID,
        ResourceCandidateRef.JSON_PROPERTY_HREF,
        ResourceCandidateRef.JSON_PROPERTY_NAME,
        ResourceCandidateRef.JSON_PROPERTY_VERSION,
        ResourceCandidateRef.JSON_PROPERTY_AT_BASE_TYPE,
        ResourceCandidateRef.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ResourceCandidateRef.JSON_PROPERTY_AT_TYPE,
        ResourceCandidateRef.JSON_PROPERTY_AT_REFERRED_TYPE
    })
@lombok.Data
@lombok.Builder
...
public class ResourceCandidateRef implements Serializable {
