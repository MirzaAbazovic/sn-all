...
*/
    @JsonPropertyOrder({
        ResourceSpecificationCreate.JSON_PROPERTY_CATEGORY,
        ResourceSpecificationCreate.JSON_PROPERTY_DESCRIPTION,
        ResourceSpecificationCreate.JSON_PROPERTY_IS_BUNDLE,
        ResourceSpecificationCreate.JSON_PROPERTY_LAST_UPDATE,
        ResourceSpecificationCreate.JSON_PROPERTY_LIFECYCLE_STATUS,
        ResourceSpecificationCreate.JSON_PROPERTY_NAME,
        ResourceSpecificationCreate.JSON_PROPERTY_VERSION,
        ResourceSpecificationCreate.JSON_PROPERTY_ATTACHMENT,
        ResourceSpecificationCreate.JSON_PROPERTY_FEATURE_SPECIFICATION,
        ResourceSpecificationCreate.JSON_PROPERTY_RELATED_PARTY,
        ResourceSpecificationCreate.JSON_PROPERTY_RESOURCE_SPEC_CHARACTERISTIC,
        ResourceSpecificationCreate.JSON_PROPERTY_RESOURCE_SPEC_RELATIONSHIP,
        ResourceSpecificationCreate.JSON_PROPERTY_TARGET_RESOURCE_SCHEMA,
        ResourceSpecificationCreate.JSON_PROPERTY_VALID_FOR,
        ResourceSpecificationCreate.JSON_PROPERTY_AT_BASE_TYPE,
        ResourceSpecificationCreate.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ResourceSpecificationCreate.JSON_PROPERTY_AT_TYPE
    })
...
public class ResourceSpecificationCreate implements Serializable {
