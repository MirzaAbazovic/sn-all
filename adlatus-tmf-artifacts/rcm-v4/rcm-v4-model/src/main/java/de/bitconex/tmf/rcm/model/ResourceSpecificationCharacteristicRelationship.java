...
*/
    @JsonPropertyOrder({
        ResourceSpecificationCharacteristicRelationship.JSON_PROPERTY_CHARACTERISTIC_SPECIFICATION_ID,
        ResourceSpecificationCharacteristicRelationship.JSON_PROPERTY_NAME,
        ResourceSpecificationCharacteristicRelationship.JSON_PROPERTY_RELATIONSHIP_TYPE,
        ResourceSpecificationCharacteristicRelationship.JSON_PROPERTY_RESOURCE_SPECIFICATION_HREF,
        ResourceSpecificationCharacteristicRelationship.JSON_PROPERTY_RESOURCE_SPECIFICATION_ID,
        ResourceSpecificationCharacteristicRelationship.JSON_PROPERTY_VALID_FOR,
        ResourceSpecificationCharacteristicRelationship.JSON_PROPERTY_AT_BASE_TYPE,
        ResourceSpecificationCharacteristicRelationship.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ResourceSpecificationCharacteristicRelationship.JSON_PROPERTY_AT_TYPE
    })
@lombok.Data
@lombok.Builder
...
public class ResourceSpecificationCharacteristicRelationship implements Serializable {
