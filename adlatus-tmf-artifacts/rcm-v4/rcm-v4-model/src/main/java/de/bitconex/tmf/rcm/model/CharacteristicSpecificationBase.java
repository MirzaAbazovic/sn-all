...
*/
    @JsonPropertyOrder({
        CharacteristicSpecificationBase.JSON_PROPERTY_ID,
        CharacteristicSpecificationBase.JSON_PROPERTY_CONFIGURABLE,
        CharacteristicSpecificationBase.JSON_PROPERTY_DESCRIPTION,
        CharacteristicSpecificationBase.JSON_PROPERTY_EXTENSIBLE,
        CharacteristicSpecificationBase.JSON_PROPERTY_IS_UNIQUE,
        CharacteristicSpecificationBase.JSON_PROPERTY_MAX_CARDINALITY,
        CharacteristicSpecificationBase.JSON_PROPERTY_MIN_CARDINALITY,
        CharacteristicSpecificationBase.JSON_PROPERTY_NAME,
        CharacteristicSpecificationBase.JSON_PROPERTY_REGEX,
        CharacteristicSpecificationBase.JSON_PROPERTY_VALUE_TYPE,
        CharacteristicSpecificationBase.JSON_PROPERTY_VALID_FOR,
        CharacteristicSpecificationBase.JSON_PROPERTY_AT_BASE_TYPE,
        CharacteristicSpecificationBase.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        CharacteristicSpecificationBase.JSON_PROPERTY_AT_TYPE,
        CharacteristicSpecificationBase.JSON_PROPERTY_AT_VALUE_SCHEMA_LOCATION
    })
@lombok.Data
@lombok.Builder
...
public class CharacteristicSpecificationBase implements Serializable {
