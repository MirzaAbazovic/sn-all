...
*/
    @JsonPropertyOrder({
        LogicalResourceSpecification.JSON_PROPERTY_ID,
        LogicalResourceSpecification.JSON_PROPERTY_HREF,
        LogicalResourceSpecification.JSON_PROPERTY_CATEGORY,
        LogicalResourceSpecification.JSON_PROPERTY_DESCRIPTION,
        LogicalResourceSpecification.JSON_PROPERTY_IS_BUNDLE,
        LogicalResourceSpecification.JSON_PROPERTY_LAST_UPDATE,
        LogicalResourceSpecification.JSON_PROPERTY_LIFECYCLE_STATUS,
        LogicalResourceSpecification.JSON_PROPERTY_NAME,
        LogicalResourceSpecification.JSON_PROPERTY_VERSION,
        LogicalResourceSpecification.JSON_PROPERTY_ATTACHMENT,
        LogicalResourceSpecification.JSON_PROPERTY_FEATURE_SPECIFICATION,
        LogicalResourceSpecification.JSON_PROPERTY_RELATED_PARTY,
        LogicalResourceSpecification.JSON_PROPERTY_RESOURCE_SPEC_CHARACTERISTIC,
        LogicalResourceSpecification.JSON_PROPERTY_RESOURCE_SPEC_RELATIONSHIP,
        LogicalResourceSpecification.JSON_PROPERTY_TARGET_RESOURCE_SCHEMA,
        LogicalResourceSpecification.JSON_PROPERTY_VALID_FOR,
        LogicalResourceSpecification.JSON_PROPERTY_AT_BASE_TYPE,
        LogicalResourceSpecification.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        LogicalResourceSpecification.JSON_PROPERTY_AT_TYPE
    })
@lombok.Data
@lombok.Builder
...
public class LogicalResourceSpecification implements Serializable {
