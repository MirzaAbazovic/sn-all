...
*/
    @JsonPropertyOrder({
        ConnectionPointSpecificationRef.JSON_PROPERTY_ID,
        ConnectionPointSpecificationRef.JSON_PROPERTY_HREF,
        ConnectionPointSpecificationRef.JSON_PROPERTY_NAME,
        ConnectionPointSpecificationRef.JSON_PROPERTY_VERSION,
        ConnectionPointSpecificationRef.JSON_PROPERTY_AT_BASE_TYPE,
        ConnectionPointSpecificationRef.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ConnectionPointSpecificationRef.JSON_PROPERTY_AT_TYPE,
        ConnectionPointSpecificationRef.JSON_PROPERTY_AT_REFERRED_TYPE
    })
@lombok.Data
@lombok.Builder
...
public class ConnectionPointSpecificationRef implements Serializable {
