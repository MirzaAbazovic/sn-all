...
*/
    @JsonPropertyOrder({
        ResourceCatalog.JSON_PROPERTY_ID,
        ResourceCatalog.JSON_PROPERTY_HREF,
        ResourceCatalog.JSON_PROPERTY_DESCRIPTION,
        ResourceCatalog.JSON_PROPERTY_LAST_UPDATE,
        ResourceCatalog.JSON_PROPERTY_LIFECYCLE_STATUS,
        ResourceCatalog.JSON_PROPERTY_NAME,
        ResourceCatalog.JSON_PROPERTY_VERSION,
        ResourceCatalog.JSON_PROPERTY_CATEGORY,
        ResourceCatalog.JSON_PROPERTY_RELATED_PARTY,
        ResourceCatalog.JSON_PROPERTY_VALID_FOR,
        ResourceCatalog.JSON_PROPERTY_AT_BASE_TYPE,
        ResourceCatalog.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ResourceCatalog.JSON_PROPERTY_AT_TYPE
    })
@lombok.Data
@lombok.Builder
