...
*/
    @JsonPropertyOrder({
        ResourceCategoryCreate.JSON_PROPERTY_DESCRIPTION,
        ResourceCategoryCreate.JSON_PROPERTY_IS_ROOT,
        ResourceCategoryCreate.JSON_PROPERTY_LAST_UPDATE,
        ResourceCategoryCreate.JSON_PROPERTY_LIFECYCLE_STATUS,
        ResourceCategoryCreate.JSON_PROPERTY_NAME,
        ResourceCategoryCreate.JSON_PROPERTY_PARENT_ID,
        ResourceCategoryCreate.JSON_PROPERTY_VERSION,
        ResourceCategoryCreate.JSON_PROPERTY_CATEGORY,
        ResourceCategoryCreate.JSON_PROPERTY_RELATED_PARTY,
        ResourceCategoryCreate.JSON_PROPERTY_RESOURCE_CANDIDATE,
        ResourceCategoryCreate.JSON_PROPERTY_VALID_FOR,
        ResourceCategoryCreate.JSON_PROPERTY_AT_BASE_TYPE,
        ResourceCategoryCreate.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ResourceCategoryCreate.JSON_PROPERTY_AT_TYPE
    })
...
public class ResourceCategoryCreate implements Serializable {
