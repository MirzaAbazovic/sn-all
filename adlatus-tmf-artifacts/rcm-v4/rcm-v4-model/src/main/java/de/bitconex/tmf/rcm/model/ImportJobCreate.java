...
*/
    @JsonPropertyOrder({
        ImportJobCreate.JSON_PROPERTY_COMPLETION_DATE,
        ImportJobCreate.JSON_PROPERTY_CONTENT_TYPE,
        ImportJobCreate.JSON_PROPERTY_CREATION_DATE,
        ImportJobCreate.JSON_PROPERTY_ERROR_LOG,
        ImportJobCreate.JSON_PROPERTY_PATH,
        ImportJobCreate.JSON_PROPERTY_URL,
        ImportJobCreate.JSON_PROPERTY_STATUS,
        ImportJobCreate.JSON_PROPERTY_AT_BASE_TYPE,
        ImportJobCreate.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ImportJobCreate.JSON_PROPERTY_AT_TYPE
    })
...
public class ImportJobCreate implements Serializable {
