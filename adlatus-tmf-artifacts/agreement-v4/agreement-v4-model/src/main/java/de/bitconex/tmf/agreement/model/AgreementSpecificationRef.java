...
*/
    @JsonPropertyOrder({
        AgreementSpecificationRef.JSON_PROPERTY_ID,
        AgreementSpecificationRef.JSON_PROPERTY_HREF,
        AgreementSpecificationRef.JSON_PROPERTY_DESCRIPTION,
        AgreementSpecificationRef.JSON_PROPERTY_NAME,
        AgreementSpecificationRef.JSON_PROPERTY_AT_BASE_TYPE,
        AgreementSpecificationRef.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        AgreementSpecificationRef.JSON_PROPERTY_AT_TYPE,
        AgreementSpecificationRef.JSON_PROPERTY_AT_REFERRED_TYPE
    })
@lombok.Data
@lombok.Builder
