...
*/
    @JsonPropertyOrder({
        ResourceDeleteEvent.JSON_PROPERTY_EVENT,
        ResourceDeleteEvent.JSON_PROPERTY_EVENT_ID,
        ResourceDeleteEvent.JSON_PROPERTY_EVENT_TIME,
        ResourceDeleteEvent.JSON_PROPERTY_EVENT_TYPE,
        ResourceDeleteEvent.JSON_PROPERTY_CORRELATION_ID,
        ResourceDeleteEvent.JSON_PROPERTY_DOMAIN,
        ResourceDeleteEvent.JSON_PROPERTY_TITLE,
        ResourceDeleteEvent.JSON_PROPERTY_DESCRIPTION,
        ResourceDeleteEvent.JSON_PROPERTY_PRIORITY,
        ResourceDeleteEvent.JSON_PROPERTY_TIME_OCURRED
    })
@lombok.Data
@lombok.Builder
