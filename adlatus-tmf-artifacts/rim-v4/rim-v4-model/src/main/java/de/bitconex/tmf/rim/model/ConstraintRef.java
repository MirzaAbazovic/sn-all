...
*/
    @JsonPropertyOrder({
        ConstraintRef.JSON_PROPERTY_ID,
        ConstraintRef.JSON_PROPERTY_HREF,
        ConstraintRef.JSON_PROPERTY_NAME,
        ConstraintRef.JSON_PROPERTY_VERSION,
        ConstraintRef.JSON_PROPERTY_AT_BASE_TYPE,
        ConstraintRef.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ConstraintRef.JSON_PROPERTY_AT_TYPE,
        ConstraintRef.JSON_PROPERTY_AT_REFERRED_TYPE
    })
@lombok.Data
@lombok.Builder
