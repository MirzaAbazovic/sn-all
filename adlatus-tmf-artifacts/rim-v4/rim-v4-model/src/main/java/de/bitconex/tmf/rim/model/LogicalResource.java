...
*/
    @JsonPropertyOrder({
        LogicalResource.JSON_PROPERTY_ID,
        LogicalResource.JSON_PROPERTY_HREF,
        LogicalResource.JSON_PROPERTY_CATEGORY,
        LogicalResource.JSON_PROPERTY_DESCRIPTION,
        LogicalResource.JSON_PROPERTY_END_OPERATING_DATE,
        LogicalResource.JSON_PROPERTY_NAME,
        LogicalResource.JSON_PROPERTY_RESOURCE_VERSION,
        LogicalResource.JSON_PROPERTY_START_OPERATING_DATE,
        LogicalResource.JSON_PROPERTY_VALUE,
        LogicalResource.JSON_PROPERTY_ACTIVATION_FEATURE,
        LogicalResource.JSON_PROPERTY_ADMINISTRATIVE_STATE,
        LogicalResource.JSON_PROPERTY_ATTACHMENT,
        LogicalResource.JSON_PROPERTY_NOTE,
        LogicalResource.JSON_PROPERTY_OPERATIONAL_STATE,
        LogicalResource.JSON_PROPERTY_PLACE,
        LogicalResource.JSON_PROPERTY_RELATED_PARTY,
        LogicalResource.JSON_PROPERTY_RESOURCE_CHARACTERISTIC,
        LogicalResource.JSON_PROPERTY_RESOURCE_RELATIONSHIP,
        LogicalResource.JSON_PROPERTY_RESOURCE_SPECIFICATION,
        LogicalResource.JSON_PROPERTY_RESOURCE_STATUS,
        LogicalResource.JSON_PROPERTY_USAGE_STATE,
        LogicalResource.JSON_PROPERTY_AT_BASE_TYPE,
        LogicalResource.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        LogicalResource.JSON_PROPERTY_AT_TYPE
    })
@lombok.Data
@lombok.Builder
...
public class LogicalResource implements Serializable {
