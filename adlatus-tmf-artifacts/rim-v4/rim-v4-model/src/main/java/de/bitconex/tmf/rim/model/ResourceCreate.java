...
*/
    @JsonPropertyOrder({
        ResourceCreate.JSON_PROPERTY_CATEGORY,
        ResourceCreate.JSON_PROPERTY_DESCRIPTION,
        ResourceCreate.JSON_PROPERTY_END_OPERATING_DATE,
        ResourceCreate.JSON_PROPERTY_NAME,
        ResourceCreate.JSON_PROPERTY_RESOURCE_VERSION,
        ResourceCreate.JSON_PROPERTY_START_OPERATING_DATE,
        ResourceCreate.JSON_PROPERTY_ACTIVATION_FEATURE,
        ResourceCreate.JSON_PROPERTY_ADMINISTRATIVE_STATE,
        ResourceCreate.JSON_PROPERTY_ATTACHMENT,
        ResourceCreate.JSON_PROPERTY_NOTE,
        ResourceCreate.JSON_PROPERTY_OPERATIONAL_STATE,
        ResourceCreate.JSON_PROPERTY_PLACE,
        ResourceCreate.JSON_PROPERTY_RELATED_PARTY,
        ResourceCreate.JSON_PROPERTY_RESOURCE_CHARACTERISTIC,
        ResourceCreate.JSON_PROPERTY_RESOURCE_RELATIONSHIP,
        ResourceCreate.JSON_PROPERTY_RESOURCE_SPECIFICATION,
        ResourceCreate.JSON_PROPERTY_RESOURCE_STATUS,
        ResourceCreate.JSON_PROPERTY_USAGE_STATE,
        ResourceCreate.JSON_PROPERTY_AT_BASE_TYPE,
        ResourceCreate.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ResourceCreate.JSON_PROPERTY_AT_TYPE
    })
            @JsonTypeName("Resource_Create")
@lombok.Data
@lombok.Builder
