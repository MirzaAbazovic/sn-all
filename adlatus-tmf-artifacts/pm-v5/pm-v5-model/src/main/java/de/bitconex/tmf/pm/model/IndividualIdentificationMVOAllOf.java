...
*/
    @JsonPropertyOrder({
        IndividualIdentificationMVOAllOf.JSON_PROPERTY_IDENTIFICATION_ID,
        IndividualIdentificationMVOAllOf.JSON_PROPERTY_ISSUING_AUTHORITY,
        IndividualIdentificationMVOAllOf.JSON_PROPERTY_ISSUING_DATE,
        IndividualIdentificationMVOAllOf.JSON_PROPERTY_IDENTIFICATION_TYPE,
        IndividualIdentificationMVOAllOf.JSON_PROPERTY_VALID_FOR,
        IndividualIdentificationMVOAllOf.JSON_PROPERTY_ATTACHMENT
    })
            @JsonTypeName("IndividualIdentification_MVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class IndividualIdentificationMVOAllOf {
