...
*/
    @JsonPropertyOrder({
        IndividualFVOAllOf.JSON_PROPERTY_GENDER,
        IndividualFVOAllOf.JSON_PROPERTY_PLACE_OF_BIRTH,
        IndividualFVOAllOf.JSON_PROPERTY_COUNTRY_OF_BIRTH,
        IndividualFVOAllOf.JSON_PROPERTY_NATIONALITY,
        IndividualFVOAllOf.JSON_PROPERTY_MARITAL_STATUS,
        IndividualFVOAllOf.JSON_PROPERTY_BIRTH_DATE,
        IndividualFVOAllOf.JSON_PROPERTY_DEATH_DATE,
        IndividualFVOAllOf.JSON_PROPERTY_TITLE,
        IndividualFVOAllOf.JSON_PROPERTY_ARISTOCRATIC_TITLE,
        IndividualFVOAllOf.JSON_PROPERTY_GENERATION,
        IndividualFVOAllOf.JSON_PROPERTY_PREFERRED_GIVEN_NAME,
        IndividualFVOAllOf.JSON_PROPERTY_FAMILY_NAME_PREFIX,
        IndividualFVOAllOf.JSON_PROPERTY_LEGAL_NAME,
        IndividualFVOAllOf.JSON_PROPERTY_MIDDLE_NAME,
        IndividualFVOAllOf.JSON_PROPERTY_NAME,
        IndividualFVOAllOf.JSON_PROPERTY_FORMATTED_NAME,
        IndividualFVOAllOf.JSON_PROPERTY_LOCATION,
        IndividualFVOAllOf.JSON_PROPERTY_STATUS,
        IndividualFVOAllOf.JSON_PROPERTY_OTHER_NAME,
        IndividualFVOAllOf.JSON_PROPERTY_INDIVIDUAL_IDENTIFICATION,
        IndividualFVOAllOf.JSON_PROPERTY_DISABILITY,
        IndividualFVOAllOf.JSON_PROPERTY_LANGUAGE_ABILITY,
        IndividualFVOAllOf.JSON_PROPERTY_SKILL,
        IndividualFVOAllOf.JSON_PROPERTY_FAMILY_NAME,
        IndividualFVOAllOf.JSON_PROPERTY_GIVEN_NAME
    })
            @JsonTypeName("Individual_FVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class IndividualFVOAllOf {
