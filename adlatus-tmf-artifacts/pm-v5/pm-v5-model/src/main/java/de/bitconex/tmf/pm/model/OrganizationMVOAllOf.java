...
*/
    @JsonPropertyOrder({
        OrganizationMVOAllOf.JSON_PROPERTY_IS_LEGAL_ENTITY,
        OrganizationMVOAllOf.JSON_PROPERTY_IS_HEAD_OFFICE,
        OrganizationMVOAllOf.JSON_PROPERTY_ORGANIZATION_TYPE,
        OrganizationMVOAllOf.JSON_PROPERTY_EXISTS_DURING,
        OrganizationMVOAllOf.JSON_PROPERTY_NAME,
        OrganizationMVOAllOf.JSON_PROPERTY_NAME_TYPE,
        OrganizationMVOAllOf.JSON_PROPERTY_STATUS,
        OrganizationMVOAllOf.JSON_PROPERTY_OTHER_NAME,
        OrganizationMVOAllOf.JSON_PROPERTY_ORGANIZATION_IDENTIFICATION,
        OrganizationMVOAllOf.JSON_PROPERTY_ORGANIZATION_CHILD_RELATIONSHIP,
        OrganizationMVOAllOf.JSON_PROPERTY_ORGANIZATION_PARENT_RELATIONSHIP,
        OrganizationMVOAllOf.JSON_PROPERTY_TRADING_NAME
    })
            @JsonTypeName("Organization_MVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class OrganizationMVOAllOf {
