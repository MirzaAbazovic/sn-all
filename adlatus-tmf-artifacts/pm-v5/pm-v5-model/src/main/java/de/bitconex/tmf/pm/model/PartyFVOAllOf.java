...
*/
    @JsonPropertyOrder({
        PartyFVOAllOf.JSON_PROPERTY_EXTERNAL_REFERENCE,
        PartyFVOAllOf.JSON_PROPERTY_PARTY_CHARACTERISTIC,
        PartyFVOAllOf.JSON_PROPERTY_TAX_EXEMPTION_CERTIFICATE,
        PartyFVOAllOf.JSON_PROPERTY_CREDIT_RATING,
        PartyFVOAllOf.JSON_PROPERTY_RELATED_PARTY,
        PartyFVOAllOf.JSON_PROPERTY_CONTACT_MEDIUM
    })
            @JsonTypeName("Party_FVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class PartyFVOAllOf {
