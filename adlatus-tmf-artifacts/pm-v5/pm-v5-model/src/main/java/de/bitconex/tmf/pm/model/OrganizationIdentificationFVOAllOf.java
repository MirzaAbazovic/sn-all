...
*/
    @JsonPropertyOrder({
        OrganizationIdentificationFVOAllOf.JSON_PROPERTY_IDENTIFICATION_ID,
        OrganizationIdentificationFVOAllOf.JSON_PROPERTY_ISSUING_AUTHORITY,
        OrganizationIdentificationFVOAllOf.JSON_PROPERTY_ISSUING_DATE,
        OrganizationIdentificationFVOAllOf.JSON_PROPERTY_IDENTIFICATION_TYPE,
        OrganizationIdentificationFVOAllOf.JSON_PROPERTY_VALID_FOR,
        OrganizationIdentificationFVOAllOf.JSON_PROPERTY_ATTACHMENT
    })
            @JsonTypeName("OrganizationIdentification_FVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class OrganizationIdentificationFVOAllOf {
