...
*/
    @JsonPropertyOrder({
        IndividualMVOAllOf.JSON_PROPERTY_GENDER,
        IndividualMVOAllOf.JSON_PROPERTY_PLACE_OF_BIRTH,
        IndividualMVOAllOf.JSON_PROPERTY_COUNTRY_OF_BIRTH,
        IndividualMVOAllOf.JSON_PROPERTY_NATIONALITY,
        IndividualMVOAllOf.JSON_PROPERTY_MARITAL_STATUS,
        IndividualMVOAllOf.JSON_PROPERTY_BIRTH_DATE,
        IndividualMVOAllOf.JSON_PROPERTY_DEATH_DATE,
        IndividualMVOAllOf.JSON_PROPERTY_TITLE,
        IndividualMVOAllOf.JSON_PROPERTY_ARISTOCRATIC_TITLE,
        IndividualMVOAllOf.JSON_PROPERTY_GENERATION,
        IndividualMVOAllOf.JSON_PROPERTY_PREFERRED_GIVEN_NAME,
        IndividualMVOAllOf.JSON_PROPERTY_FAMILY_NAME_PREFIX,
        IndividualMVOAllOf.JSON_PROPERTY_LEGAL_NAME,
        IndividualMVOAllOf.JSON_PROPERTY_MIDDLE_NAME,
        IndividualMVOAllOf.JSON_PROPERTY_NAME,
        IndividualMVOAllOf.JSON_PROPERTY_FORMATTED_NAME,
        IndividualMVOAllOf.JSON_PROPERTY_LOCATION,
        IndividualMVOAllOf.JSON_PROPERTY_STATUS,
        IndividualMVOAllOf.JSON_PROPERTY_OTHER_NAME,
        IndividualMVOAllOf.JSON_PROPERTY_INDIVIDUAL_IDENTIFICATION,
        IndividualMVOAllOf.JSON_PROPERTY_DISABILITY,
        IndividualMVOAllOf.JSON_PROPERTY_LANGUAGE_ABILITY,
        IndividualMVOAllOf.JSON_PROPERTY_SKILL,
        IndividualMVOAllOf.JSON_PROPERTY_FAMILY_NAME,
        IndividualMVOAllOf.JSON_PROPERTY_GIVEN_NAME
    })
            @JsonTypeName("Individual_MVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class IndividualMVOAllOf {
