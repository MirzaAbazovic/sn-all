...
*/
    @JsonPropertyOrder({
        RelatedPartyOrPartyRoleMVOAllOf.JSON_PROPERTY_ROLE,
        RelatedPartyOrPartyRoleMVOAllOf.JSON_PROPERTY_PARTY_OR_PARTY_ROLE
    })
            @JsonTypeName("RelatedPartyOrPartyRole_MVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class RelatedPartyOrPartyRoleMVOAllOf {
