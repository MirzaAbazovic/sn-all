...
*/
    @JsonPropertyOrder({
        RelatedPartyOrPartyRoleFVOAllOf.JSON_PROPERTY_ROLE,
        RelatedPartyOrPartyRoleFVOAllOf.JSON_PROPERTY_PARTY_OR_PARTY_ROLE
    })
            @JsonTypeName("RelatedPartyOrPartyRole_FVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class RelatedPartyOrPartyRoleFVOAllOf {
