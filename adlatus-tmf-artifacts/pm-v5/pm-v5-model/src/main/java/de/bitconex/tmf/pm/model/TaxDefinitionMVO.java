...
*/
    @JsonPropertyOrder({
        TaxDefinitionMVO.JSON_PROPERTY_AT_TYPE,
        TaxDefinitionMVO.JSON_PROPERTY_AT_BASE_TYPE,
        TaxDefinitionMVO.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        TaxDefinitionMVO.JSON_PROPERTY_ID,
        TaxDefinitionMVO.JSON_PROPERTY_NAME,
        TaxDefinitionMVO.JSON_PROPERTY_VALID_FOR,
        TaxDefinitionMVO.JSON_PROPERTY_JURISDICTION_NAME,
        TaxDefinitionMVO.JSON_PROPERTY_JURISDICTION_LEVEL,
        TaxDefinitionMVO.JSON_PROPERTY_TAX_TYPE
    })
@lombok.Data
@lombok.Builder
