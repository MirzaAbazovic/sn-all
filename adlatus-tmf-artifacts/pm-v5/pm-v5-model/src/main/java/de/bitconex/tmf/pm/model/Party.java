...
*/
    @JsonPropertyOrder({
        Party.JSON_PROPERTY_AT_TYPE,
        Party.JSON_PROPERTY_AT_BASE_TYPE,
        Party.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        Party.JSON_PROPERTY_HREF,
        Party.JSON_PROPERTY_ID,
        Party.JSON_PROPERTY_EXTERNAL_REFERENCE,
        Party.JSON_PROPERTY_PARTY_CHARACTERISTIC,
        Party.JSON_PROPERTY_TAX_EXEMPTION_CERTIFICATE,
        Party.JSON_PROPERTY_CREDIT_RATING,
        Party.JSON_PROPERTY_RELATED_PARTY,
        Party.JSON_PROPERTY_CONTACT_MEDIUM
    })
@lombok.Data
@lombok.Builder
