...
*/
    @JsonPropertyOrder({
        IndividualIdentificationAllOf.JSON_PROPERTY_IDENTIFICATION_ID,
        IndividualIdentificationAllOf.JSON_PROPERTY_ISSUING_AUTHORITY,
        IndividualIdentificationAllOf.JSON_PROPERTY_ISSUING_DATE,
        IndividualIdentificationAllOf.JSON_PROPERTY_IDENTIFICATION_TYPE,
        IndividualIdentificationAllOf.JSON_PROPERTY_VALID_FOR,
        IndividualIdentificationAllOf.JSON_PROPERTY_ATTACHMENT
    })
            @JsonTypeName("IndividualIdentification_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class IndividualIdentificationAllOf {
