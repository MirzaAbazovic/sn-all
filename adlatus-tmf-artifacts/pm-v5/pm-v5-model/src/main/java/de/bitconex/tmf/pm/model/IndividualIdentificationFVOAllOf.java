...
*/
    @JsonPropertyOrder({
        IndividualIdentificationFVOAllOf.JSON_PROPERTY_IDENTIFICATION_ID,
        IndividualIdentificationFVOAllOf.JSON_PROPERTY_ISSUING_AUTHORITY,
        IndividualIdentificationFVOAllOf.JSON_PROPERTY_ISSUING_DATE,
        IndividualIdentificationFVOAllOf.JSON_PROPERTY_IDENTIFICATION_TYPE,
        IndividualIdentificationFVOAllOf.JSON_PROPERTY_VALID_FOR,
        IndividualIdentificationFVOAllOf.JSON_PROPERTY_ATTACHMENT
    })
            @JsonTypeName("IndividualIdentification_FVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class IndividualIdentificationFVOAllOf {
