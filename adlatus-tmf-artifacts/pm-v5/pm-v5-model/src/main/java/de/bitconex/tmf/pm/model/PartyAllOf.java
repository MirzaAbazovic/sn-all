...
*/
    @JsonPropertyOrder({
        PartyAllOf.JSON_PROPERTY_EXTERNAL_REFERENCE,
        PartyAllOf.JSON_PROPERTY_PARTY_CHARACTERISTIC,
        PartyAllOf.JSON_PROPERTY_TAX_EXEMPTION_CERTIFICATE,
        PartyAllOf.JSON_PROPERTY_CREDIT_RATING,
        PartyAllOf.JSON_PROPERTY_RELATED_PARTY,
        PartyAllOf.JSON_PROPERTY_CONTACT_MEDIUM
    })
            @JsonTypeName("Party_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class PartyAllOf {
