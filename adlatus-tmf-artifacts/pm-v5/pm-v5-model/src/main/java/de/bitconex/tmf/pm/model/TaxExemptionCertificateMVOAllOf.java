...
*/
    @JsonPropertyOrder({
        TaxExemptionCertificateMVOAllOf.JSON_PROPERTY_ID,
        TaxExemptionCertificateMVOAllOf.JSON_PROPERTY_TAX_DEFINITION,
        TaxExemptionCertificateMVOAllOf.JSON_PROPERTY_VALID_FOR,
        TaxExemptionCertificateMVOAllOf.JSON_PROPERTY_CERTIFICATE_NUMBER,
        TaxExemptionCertificateMVOAllOf.JSON_PROPERTY_ISSUING_JURISDICTION,
        TaxExemptionCertificateMVOAllOf.JSON_PROPERTY_REASON,
        TaxExemptionCertificateMVOAllOf.JSON_PROPERTY_ATTACHMENT
    })
            @JsonTypeName("TaxExemptionCertificate_MVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class TaxExemptionCertificateMVOAllOf {
