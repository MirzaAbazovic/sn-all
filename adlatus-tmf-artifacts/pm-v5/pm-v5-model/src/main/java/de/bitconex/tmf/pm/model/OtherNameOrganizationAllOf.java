...
*/
    @JsonPropertyOrder({
        OtherNameOrganizationAllOf.JSON_PROPERTY_TRADING_NAME,
        OtherNameOrganizationAllOf.JSON_PROPERTY_NAME_TYPE,
        OtherNameOrganizationAllOf.JSON_PROPERTY_NAME,
        OtherNameOrganizationAllOf.JSON_PROPERTY_VALID_FOR
    })
            @JsonTypeName("OtherNameOrganization_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class OtherNameOrganizationAllOf {
