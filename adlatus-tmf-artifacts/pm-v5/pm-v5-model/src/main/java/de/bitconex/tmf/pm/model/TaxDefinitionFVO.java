...
*/
    @JsonPropertyOrder({
        TaxDefinitionFVO.JSON_PROPERTY_AT_TYPE,
        TaxDefinitionFVO.JSON_PROPERTY_AT_BASE_TYPE,
        TaxDefinitionFVO.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        TaxDefinitionFVO.JSON_PROPERTY_ID,
        TaxDefinitionFVO.JSON_PROPERTY_NAME,
        TaxDefinitionFVO.JSON_PROPERTY_VALID_FOR,
        TaxDefinitionFVO.JSON_PROPERTY_JURISDICTION_NAME,
        TaxDefinitionFVO.JSON_PROPERTY_JURISDICTION_LEVEL,
        TaxDefinitionFVO.JSON_PROPERTY_TAX_TYPE
    })
@lombok.Data
@lombok.Builder
