...
*/
    @JsonPropertyOrder({
        OrganizationIdentificationMVOAllOf.JSON_PROPERTY_IDENTIFICATION_ID,
        OrganizationIdentificationMVOAllOf.JSON_PROPERTY_ISSUING_AUTHORITY,
        OrganizationIdentificationMVOAllOf.JSON_PROPERTY_ISSUING_DATE,
        OrganizationIdentificationMVOAllOf.JSON_PROPERTY_IDENTIFICATION_TYPE,
        OrganizationIdentificationMVOAllOf.JSON_PROPERTY_VALID_FOR,
        OrganizationIdentificationMVOAllOf.JSON_PROPERTY_ATTACHMENT
    })
            @JsonTypeName("OrganizationIdentification_MVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class OrganizationIdentificationMVOAllOf {
