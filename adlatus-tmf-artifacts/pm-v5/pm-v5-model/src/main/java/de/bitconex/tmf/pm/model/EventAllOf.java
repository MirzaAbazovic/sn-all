...
*/
    @JsonPropertyOrder({
        EventAllOf.JSON_PROPERTY_HREF,
        EventAllOf.JSON_PROPERTY_ID,
        EventAllOf.JSON_PROPERTY_CORRELATION_ID,
        EventAllOf.JSON_PROPERTY_DOMAIN,
        EventAllOf.JSON_PROPERTY_TITLE,
        EventAllOf.JSON_PROPERTY_DESCRIPTION,
        EventAllOf.JSON_PROPERTY_PRIORITY,
        EventAllOf.JSON_PROPERTY_TIME_OCCURRED,
        EventAllOf.JSON_PROPERTY_SOURCE,
        EventAllOf.JSON_PROPERTY_REPORTING_SYSTEM,
        EventAllOf.JSON_PROPERTY_RELATED_PARTY,
        EventAllOf.JSON_PROPERTY_ANALYTIC_CHARACTERISTIC,
        EventAllOf.JSON_PROPERTY_EVENT_ID,
        EventAllOf.JSON_PROPERTY_EVENT_TIME,
        EventAllOf.JSON_PROPERTY_EVENT_TYPE,
        EventAllOf.JSON_PROPERTY_EVENT
    })
