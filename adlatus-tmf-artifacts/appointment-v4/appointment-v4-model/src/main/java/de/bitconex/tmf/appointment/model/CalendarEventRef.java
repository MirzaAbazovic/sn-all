...
*/
    @JsonPropertyOrder({
        CalendarEventRef.JSON_PROPERTY_ID,
        CalendarEventRef.JSON_PROPERTY_HREF,
        CalendarEventRef.JSON_PROPERTY_NAME,
        CalendarEventRef.JSON_PROPERTY_AT_BASE_TYPE,
        CalendarEventRef.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        CalendarEventRef.JSON_PROPERTY_AT_TYPE,
        CalendarEventRef.JSON_PROPERTY_AT_REFERRED_TYPE
    })
@lombok.Data
@lombok.Builder
...
public class CalendarEventRef implements Serializable {
