...
*/
    @JsonPropertyOrder({
        AppointmentDeleteEvent.JSON_PROPERTY_ID,
        AppointmentDeleteEvent.JSON_PROPERTY_HREF,
        AppointmentDeleteEvent.JSON_PROPERTY_EVENT_ID,
        AppointmentDeleteEvent.JSON_PROPERTY_EVENT_TIME,
        AppointmentDeleteEvent.JSON_PROPERTY_EVENT_TYPE,
        AppointmentDeleteEvent.JSON_PROPERTY_CORRELATION_ID,
        AppointmentDeleteEvent.JSON_PROPERTY_DOMAIN,
        AppointmentDeleteEvent.JSON_PROPERTY_TITLE,
        AppointmentDeleteEvent.JSON_PROPERTY_DESCRIPTION,
        AppointmentDeleteEvent.JSON_PROPERTY_PRIORITY,
        AppointmentDeleteEvent.JSON_PROPERTY_TIME_OCURRED,
        AppointmentDeleteEvent.JSON_PROPERTY_EVENT
    })
@lombok.Data
@lombok.Builder
...
public class AppointmentDeleteEvent implements Serializable {
