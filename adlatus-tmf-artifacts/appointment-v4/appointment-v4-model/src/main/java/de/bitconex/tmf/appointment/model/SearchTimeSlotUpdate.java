...
*/
    @JsonPropertyOrder({
        SearchTimeSlotUpdate.JSON_PROPERTY_AVAILABLE_TIME_SLOT,
        SearchTimeSlotUpdate.JSON_PROPERTY_RELATED_ENTITY,
        SearchTimeSlotUpdate.JSON_PROPERTY_RELATED_PARTY,
        SearchTimeSlotUpdate.JSON_PROPERTY_RELATED_PLACE,
        SearchTimeSlotUpdate.JSON_PROPERTY_REQUESTED_TIME_SLOT,
        SearchTimeSlotUpdate.JSON_PROPERTY_STATUS,
        SearchTimeSlotUpdate.JSON_PROPERTY_AT_BASE_TYPE,
        SearchTimeSlotUpdate.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        SearchTimeSlotUpdate.JSON_PROPERTY_AT_TYPE
    })
...
public class SearchTimeSlotUpdate implements Serializable {
