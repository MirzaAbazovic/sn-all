...
*/
    @JsonPropertyOrder({
        SearchTimeSlot.JSON_PROPERTY_ID,
        SearchTimeSlot.JSON_PROPERTY_HREF,
        SearchTimeSlot.JSON_PROPERTY_SEARCH_DATE,
        SearchTimeSlot.JSON_PROPERTY_SEARCH_RESULT,
        SearchTimeSlot.JSON_PROPERTY_AVAILABLE_TIME_SLOT,
        SearchTimeSlot.JSON_PROPERTY_RELATED_ENTITY,
        SearchTimeSlot.JSON_PROPERTY_RELATED_PARTY,
        SearchTimeSlot.JSON_PROPERTY_RELATED_PLACE,
        SearchTimeSlot.JSON_PROPERTY_REQUESTED_TIME_SLOT,
        SearchTimeSlot.JSON_PROPERTY_STATUS,
        SearchTimeSlot.JSON_PROPERTY_AT_BASE_TYPE,
        SearchTimeSlot.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        SearchTimeSlot.JSON_PROPERTY_AT_TYPE
    })
@lombok.Data
@lombok.Builder
...
public class SearchTimeSlot implements Serializable {
        ...
        public static final String JSON_PROPERTY_SEARCH_RESULT = "searchResult";
            private String searchResult;

        public static final String JSON_PROPERTY_AVAILABLE_TIME_SLOT = "availableTimeSlot";
