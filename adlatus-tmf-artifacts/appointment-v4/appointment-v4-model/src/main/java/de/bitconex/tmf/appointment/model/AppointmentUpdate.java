...
*/
    @JsonPropertyOrder({
        AppointmentUpdate.JSON_PROPERTY_CATEGORY,
        AppointmentUpdate.JSON_PROPERTY_DESCRIPTION,
        AppointmentUpdate.JSON_PROPERTY_EXTERNAL_ID,
        AppointmentUpdate.JSON_PROPERTY_LAST_UPDATE,
        AppointmentUpdate.JSON_PROPERTY_ATTACHMENT,
        AppointmentUpdate.JSON_PROPERTY_CALENDAR_EVENT,
        AppointmentUpdate.JSON_PROPERTY_CONTACT_MEDIUM,
        AppointmentUpdate.JSON_PROPERTY_NOTE,
        AppointmentUpdate.JSON_PROPERTY_RELATED_ENTITY,
        AppointmentUpdate.JSON_PROPERTY_RELATED_PARTY,
        AppointmentUpdate.JSON_PROPERTY_RELATED_PLACE,
        AppointmentUpdate.JSON_PROPERTY_STATUS,
        AppointmentUpdate.JSON_PROPERTY_VALID_FOR,
        AppointmentUpdate.JSON_PROPERTY_AT_BASE_TYPE,
        AppointmentUpdate.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        AppointmentUpdate.JSON_PROPERTY_AT_TYPE
    })
...
public class AppointmentUpdate implements Serializable {
