...
*/
    @JsonPropertyOrder({
        ResourceCandidateMVOAllOf.JSON_PROPERTY_DESCRIPTION,
        ResourceCandidateMVOAllOf.JSON_PROPERTY_VERSION,
        ResourceCandidateMVOAllOf.JSON_PROPERTY_VALID_FOR,
        ResourceCandidateMVOAllOf.JSON_PROPERTY_LAST_UPDATE,
        ResourceCandidateMVOAllOf.JSON_PROPERTY_LIFECYCLE_STATUS,
        ResourceCandidateMVOAllOf.JSON_PROPERTY_CATEGORY,
        ResourceCandidateMVOAllOf.JSON_PROPERTY_RESOURCE_SPECIFICATION,
        ResourceCandidateMVOAllOf.JSON_PROPERTY_EXTERNAL_IDENTIFIER
    })
            @JsonTypeName("ResourceCandidate_MVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class ResourceCandidateMVOAllOf {
