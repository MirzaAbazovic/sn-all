...
*/
    @JsonPropertyOrder({
        PolicyRefFVOAllOf.JSON_PROPERTY_ID,
        PolicyRefFVOAllOf.JSON_PROPERTY_HREF,
        PolicyRefFVOAllOf.JSON_PROPERTY_VERSION,
        PolicyRefFVOAllOf.JSON_PROPERTY_AT_TYPE,
        PolicyRefFVOAllOf.JSON_PROPERTY_AT_BASE_TYPE,
        PolicyRefFVOAllOf.JSON_PROPERTY_AT_SCHEMA_LOCATION
    })
            @JsonTypeName("PolicyRef_FVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class PolicyRefFVOAllOf {
