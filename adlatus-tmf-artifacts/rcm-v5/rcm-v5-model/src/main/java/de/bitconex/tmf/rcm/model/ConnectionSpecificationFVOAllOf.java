...
*/
    @JsonPropertyOrder({
        ConnectionSpecificationFVOAllOf.JSON_PROPERTY_NAME,
        ConnectionSpecificationFVOAllOf.JSON_PROPERTY_ASSOCIATION_TYPE,
        ConnectionSpecificationFVOAllOf.JSON_PROPERTY_ENDPOINT_SPECIFICATION
    })
            @JsonTypeName("ConnectionSpecification_FVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class ConnectionSpecificationFVOAllOf {
