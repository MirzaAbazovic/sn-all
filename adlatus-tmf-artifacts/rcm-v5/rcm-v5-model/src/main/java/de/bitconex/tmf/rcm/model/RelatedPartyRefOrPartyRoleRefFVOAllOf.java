...
*/
    @JsonPropertyOrder({
        RelatedPartyRefOrPartyRoleRefFVOAllOf.JSON_PROPERTY_ROLE,
        RelatedPartyRefOrPartyRoleRefFVOAllOf.JSON_PROPERTY_PARTY_OR_PARTY_ROLE
    })
            @JsonTypeName("RelatedPartyRefOrPartyRoleRef_FVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class RelatedPartyRefOrPartyRoleRefFVOAllOf {
