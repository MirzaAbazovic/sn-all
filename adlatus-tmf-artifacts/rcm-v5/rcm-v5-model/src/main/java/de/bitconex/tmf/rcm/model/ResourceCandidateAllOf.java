...
*/
    @JsonPropertyOrder({
        ResourceCandidateAllOf.JSON_PROPERTY_DESCRIPTION,
        ResourceCandidateAllOf.JSON_PROPERTY_VERSION,
        ResourceCandidateAllOf.JSON_PROPERTY_VALID_FOR,
        ResourceCandidateAllOf.JSON_PROPERTY_LAST_UPDATE,
        ResourceCandidateAllOf.JSON_PROPERTY_LIFECYCLE_STATUS,
        ResourceCandidateAllOf.JSON_PROPERTY_CATEGORY,
        ResourceCandidateAllOf.JSON_PROPERTY_RESOURCE_SPECIFICATION,
        ResourceCandidateAllOf.JSON_PROPERTY_EXTERNAL_IDENTIFIER
    })
            @JsonTypeName("ResourceCandidate_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class ResourceCandidateAllOf {
