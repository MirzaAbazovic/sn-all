...
*/
    @JsonPropertyOrder({
        Event.JSON_PROPERTY_AT_TYPE,
        Event.JSON_PROPERTY_AT_BASE_TYPE,
        Event.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        Event.JSON_PROPERTY_HREF,
        Event.JSON_PROPERTY_ID,
        Event.JSON_PROPERTY_CORRELATION_ID,
        Event.JSON_PROPERTY_DOMAIN,
        Event.JSON_PROPERTY_TITLE,
        Event.JSON_PROPERTY_DESCRIPTION,
        Event.JSON_PROPERTY_PRIORITY,
        Event.JSON_PROPERTY_TIME_OCCURRED,
        Event.JSON_PROPERTY_SOURCE,
        Event.JSON_PROPERTY_REPORTING_SYSTEM,
        Event.JSON_PROPERTY_RELATED_PARTY,
        Event.JSON_PROPERTY_ANALYTIC_CHARACTERISTIC,
        Event.JSON_PROPERTY_EVENT_ID,
        Event.JSON_PROPERTY_EVENT_TIME,
