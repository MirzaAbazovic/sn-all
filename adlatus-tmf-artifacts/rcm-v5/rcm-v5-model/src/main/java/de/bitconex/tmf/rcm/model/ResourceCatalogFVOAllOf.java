...
*/
    @JsonPropertyOrder({
        ResourceCatalogFVOAllOf.JSON_PROPERTY_CATEGORY,
        ResourceCatalogFVOAllOf.JSON_PROPERTY_EXTERNAL_IDENTIFIER
    })
            @JsonTypeName("ResourceCatalog_FVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class ResourceCatalogFVOAllOf {
