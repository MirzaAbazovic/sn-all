...
import java.util.Arrays;
    ...
    import de.bitconex.tmf.rcm.model.ResourceCandidateCreateEventPayload;
...
*/
    @JsonPropertyOrder({
        ResourceCandidateCreateEvent.JSON_PROPERTY_AT_TYPE,
        ResourceCandidateCreateEvent.JSON_PROPERTY_AT_BASE_TYPE,
        ResourceCandidateCreateEvent.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ResourceCandidateCreateEvent.JSON_PROPERTY_HREF,
        ResourceCandidateCreateEvent.JSON_PROPERTY_ID,
        ResourceCandidateCreateEvent.JSON_PROPERTY_CORRELATION_ID,
        ResourceCandidateCreateEvent.JSON_PROPERTY_DOMAIN,
        ResourceCandidateCreateEvent.JSON_PROPERTY_TITLE,
        ResourceCandidateCreateEvent.JSON_PROPERTY_DESCRIPTION,
        ResourceCandidateCreateEvent.JSON_PROPERTY_PRIORITY,
        ResourceCandidateCreateEvent.JSON_PROPERTY_TIME_OCCURRED,
        ResourceCandidateCreateEvent.JSON_PROPERTY_SOURCE,
        ResourceCandidateCreateEvent.JSON_PROPERTY_REPORTING_SYSTEM,
        ResourceCandidateCreateEvent.JSON_PROPERTY_RELATED_PARTY,
        ResourceCandidateCreateEvent.JSON_PROPERTY_ANALYTIC_CHARACTERISTIC,
        ResourceCandidateCreateEvent.JSON_PROPERTY_EVENT_ID,
        ResourceCandidateCreateEvent.JSON_PROPERTY_EVENT_TIME,
        ResourceCandidateCreateEvent.JSON_PROPERTY_EVENT_TYPE,
        ResourceCandidateCreateEvent.JSON_PROPERTY_EVENT
    })
@lombok.Data
@lombok.Builder
