...
*/
    @JsonPropertyOrder({
        PolicyRefFVO.JSON_PROPERTY_AT_TYPE,
        PolicyRefFVO.JSON_PROPERTY_AT_BASE_TYPE,
        PolicyRefFVO.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        PolicyRefFVO.JSON_PROPERTY_ID,
        PolicyRefFVO.JSON_PROPERTY_HREF,
        PolicyRefFVO.JSON_PROPERTY_NAME,
        PolicyRefFVO.JSON_PROPERTY_AT_REFERRED_TYPE,
        PolicyRefFVO.JSON_PROPERTY_VERSION
    })
@lombok.Data
@lombok.Builder
