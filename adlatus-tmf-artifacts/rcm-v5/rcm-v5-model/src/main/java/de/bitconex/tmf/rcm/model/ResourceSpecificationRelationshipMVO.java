...
*/
    @JsonPropertyOrder({
        ResourceSpecificationRelationshipMVO.JSON_PROPERTY_AT_TYPE,
        ResourceSpecificationRelationshipMVO.JSON_PROPERTY_AT_BASE_TYPE,
        ResourceSpecificationRelationshipMVO.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ResourceSpecificationRelationshipMVO.JSON_PROPERTY_RELATIONSHIP_TYPE,
        ResourceSpecificationRelationshipMVO.JSON_PROPERTY_ROLE,
        ResourceSpecificationRelationshipMVO.JSON_PROPERTY_ID,
        ResourceSpecificationRelationshipMVO.JSON_PROPERTY_HREF,
        ResourceSpecificationRelationshipMVO.JSON_PROPERTY_NAME,
        ResourceSpecificationRelationshipMVO.JSON_PROPERTY_DEFAULT_QUANTITY,
        ResourceSpecificationRelationshipMVO.JSON_PROPERTY_MAXIMUM_QUANTITY,
        ResourceSpecificationRelationshipMVO.JSON_PROPERTY_MINIMUM_QUANTITY,
        ResourceSpecificationRelationshipMVO.JSON_PROPERTY_CHARACTERISTIC,
        ResourceSpecificationRelationshipMVO.JSON_PROPERTY_VALID_FOR
    })
@lombok.Data
@lombok.Builder
