...
*/
    @JsonPropertyOrder({
        ResourceCategoryRefFVO.JSON_PROPERTY_AT_TYPE,
        ResourceCategoryRefFVO.JSON_PROPERTY_AT_BASE_TYPE,
        ResourceCategoryRefFVO.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ResourceCategoryRefFVO.JSON_PROPERTY_ID,
        ResourceCategoryRefFVO.JSON_PROPERTY_HREF,
        ResourceCategoryRefFVO.JSON_PROPERTY_NAME,
        ResourceCategoryRefFVO.JSON_PROPERTY_AT_REFERRED_TYPE,
        ResourceCategoryRefFVO.JSON_PROPERTY_VERSION
    })
@lombok.Data
@lombok.Builder
