...
*/
    @JsonPropertyOrder({
        CatalogAllOf.JSON_PROPERTY_DESCRIPTION,
        CatalogAllOf.JSON_PROPERTY_CATALOG_TYPE,
        CatalogAllOf.JSON_PROPERTY_VALID_FOR,
        CatalogAllOf.JSON_PROPERTY_VERSION,
        CatalogAllOf.JSON_PROPERTY_RELATED_PARTY,
        CatalogAllOf.JSON_PROPERTY_LAST_UPDATE,
        CatalogAllOf.JSON_PROPERTY_LIFECYCLE_STATUS,
        CatalogAllOf.JSON_PROPERTY_NAME
    })
            @JsonTypeName("Catalog_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class CatalogAllOf {
