...
*/
    @JsonPropertyOrder({
        ExportJobMVO.JSON_PROPERTY_AT_TYPE,
        ExportJobMVO.JSON_PROPERTY_AT_BASE_TYPE,
        ExportJobMVO.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ExportJobMVO.JSON_PROPERTY_COMPLETION_DATE,
        ExportJobMVO.JSON_PROPERTY_CONTENT_TYPE,
        ExportJobMVO.JSON_PROPERTY_CREATION_DATE,
        ExportJobMVO.JSON_PROPERTY_ERROR_LOG,
        ExportJobMVO.JSON_PROPERTY_PATH,
        ExportJobMVO.JSON_PROPERTY_QUERY,
        ExportJobMVO.JSON_PROPERTY_STATUS,
        ExportJobMVO.JSON_PROPERTY_URL,
        ExportJobMVO.JSON_PROPERTY_ID
    })
@lombok.Data
@lombok.Builder
