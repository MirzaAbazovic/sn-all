...
import java.util.Arrays;
    ...
    import de.bitconex.tmf.rcm.model.ImportJobCreateEventPayload;
...
*/
    @JsonPropertyOrder({
        ImportJobCreateEvent.JSON_PROPERTY_AT_TYPE,
        ImportJobCreateEvent.JSON_PROPERTY_AT_BASE_TYPE,
        ImportJobCreateEvent.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ImportJobCreateEvent.JSON_PROPERTY_HREF,
        ImportJobCreateEvent.JSON_PROPERTY_ID,
        ImportJobCreateEvent.JSON_PROPERTY_CORRELATION_ID,
        ImportJobCreateEvent.JSON_PROPERTY_DOMAIN,
        ImportJobCreateEvent.JSON_PROPERTY_TITLE,
        ImportJobCreateEvent.JSON_PROPERTY_DESCRIPTION,
        ImportJobCreateEvent.JSON_PROPERTY_PRIORITY,
        ImportJobCreateEvent.JSON_PROPERTY_TIME_OCCURRED,
        ImportJobCreateEvent.JSON_PROPERTY_SOURCE,
        ImportJobCreateEvent.JSON_PROPERTY_REPORTING_SYSTEM,
        ImportJobCreateEvent.JSON_PROPERTY_RELATED_PARTY,
        ImportJobCreateEvent.JSON_PROPERTY_ANALYTIC_CHARACTERISTIC,
        ImportJobCreateEvent.JSON_PROPERTY_EVENT_ID,
        ImportJobCreateEvent.JSON_PROPERTY_EVENT_TIME,
        ImportJobCreateEvent.JSON_PROPERTY_EVENT_TYPE,
        ImportJobCreateEvent.JSON_PROPERTY_EVENT
    })
@lombok.Data
@lombok.Builder
