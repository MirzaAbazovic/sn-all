...
*/
    @JsonPropertyOrder({
        ResourceCategoryRefMVO.JSON_PROPERTY_AT_TYPE,
        ResourceCategoryRefMVO.JSON_PROPERTY_AT_BASE_TYPE,
        ResourceCategoryRefMVO.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ResourceCategoryRefMVO.JSON_PROPERTY_HREF,
        ResourceCategoryRefMVO.JSON_PROPERTY_ID,
        ResourceCategoryRefMVO.JSON_PROPERTY_NAME,
        ResourceCategoryRefMVO.JSON_PROPERTY_AT_REFERRED_TYPE,
        ResourceCategoryRefMVO.JSON_PROPERTY_VERSION
    })
@lombok.Data
@lombok.Builder
