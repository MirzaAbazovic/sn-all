...
*/
    @JsonPropertyOrder({
        ResourceCatalogMVOAllOf.JSON_PROPERTY_CATEGORY,
        ResourceCatalogMVOAllOf.JSON_PROPERTY_EXTERNAL_IDENTIFIER
    })
            @JsonTypeName("ResourceCatalog_MVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class ResourceCatalogMVOAllOf {
