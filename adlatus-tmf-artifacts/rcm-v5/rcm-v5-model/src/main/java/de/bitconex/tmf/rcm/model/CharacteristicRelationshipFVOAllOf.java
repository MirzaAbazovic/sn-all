...
*/
    @JsonPropertyOrder({
        CharacteristicRelationshipFVOAllOf.JSON_PROPERTY_ID,
        CharacteristicRelationshipFVOAllOf.JSON_PROPERTY_RELATIONSHIP_TYPE
    })
            @JsonTypeName("CharacteristicRelationship_FVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class CharacteristicRelationshipFVOAllOf {
