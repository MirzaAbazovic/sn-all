...
*/
    @JsonPropertyOrder({
        EndpointSpecificationRefFVOAllOf.JSON_PROPERTY_ROLE,
        EndpointSpecificationRefFVOAllOf.JSON_PROPERTY_IS_ROOT,
        EndpointSpecificationRefFVOAllOf.JSON_PROPERTY_CONNECTION_POINT_SPECIFICATION
    })
            @JsonTypeName("EndpointSpecificationRef_FVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class EndpointSpecificationRefFVOAllOf {
