...
*/
    @JsonPropertyOrder({
        ResourceCategoryFVOAllOf.JSON_PROPERTY_DESCRIPTION,
        ResourceCategoryFVOAllOf.JSON_PROPERTY_NAME,
        ResourceCategoryFVOAllOf.JSON_PROPERTY_VERSION,
        ResourceCategoryFVOAllOf.JSON_PROPERTY_VALID_FOR,
        ResourceCategoryFVOAllOf.JSON_PROPERTY_LIFECYCLE_STATUS,
        ResourceCategoryFVOAllOf.JSON_PROPERTY_LAST_UPDATE,
        ResourceCategoryFVOAllOf.JSON_PROPERTY_PARENT_ID,
        ResourceCategoryFVOAllOf.JSON_PROPERTY_IS_ROOT,
        ResourceCategoryFVOAllOf.JSON_PROPERTY_CATEGORY,
        ResourceCategoryFVOAllOf.JSON_PROPERTY_RESOURCE_SPECIFICATION,
        ResourceCategoryFVOAllOf.JSON_PROPERTY_RESOURCE_CANDIDATE,
        ResourceCategoryFVOAllOf.JSON_PROPERTY_RELATED_PARTY,
        ResourceCategoryFVOAllOf.JSON_PROPERTY_EXTERNAL_IDENTIFIER
    })
            @JsonTypeName("ResourceCategory_FVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class ResourceCategoryFVOAllOf {
