...
*/
    @JsonPropertyOrder({
        ConnectionPointSpecificationRefAllOf.JSON_PROPERTY_VERSION
    })
            @JsonTypeName("ConnectionPointSpecificationRef_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class ConnectionPointSpecificationRefAllOf {
