...
import java.util.Arrays;
    ...
    import com.fasterxml.jackson.annotation.*;
        ...
        /**
* ResourceCatalogDeleteEvent generic structure
*/
    @JsonPropertyOrder({
        ResourceCatalogDeleteEventAllOf.JSON_PROPERTY_EVENT
    })
            @JsonTypeName("ResourceCatalogDeleteEvent_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class ResourceCatalogDeleteEventAllOf {
