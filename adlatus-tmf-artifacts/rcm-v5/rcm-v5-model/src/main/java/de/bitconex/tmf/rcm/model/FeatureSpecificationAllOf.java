...
*/
    @JsonPropertyOrder({
        FeatureSpecificationAllOf.JSON_PROPERTY_VERSION,
        FeatureSpecificationAllOf.JSON_PROPERTY_ID,
        FeatureSpecificationAllOf.JSON_PROPERTY_IS_BUNDLE,
        FeatureSpecificationAllOf.JSON_PROPERTY_VALID_FOR,
        FeatureSpecificationAllOf.JSON_PROPERTY_FEATURE_SPEC_RELATIONSHIP,
        FeatureSpecificationAllOf.JSON_PROPERTY_POLICY_CONSTRAINT,
        FeatureSpecificationAllOf.JSON_PROPERTY_IS_ENABLED,
        FeatureSpecificationAllOf.JSON_PROPERTY_FEATURE_SPEC_CHARACTERISTIC,
        FeatureSpecificationAllOf.JSON_PROPERTY_NAME
    })
            @JsonTypeName("FeatureSpecification_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class FeatureSpecificationAllOf {
