...
*/
    @JsonPropertyOrder({
        AttachmentRefFVO.JSON_PROPERTY_AT_TYPE,
        AttachmentRefFVO.JSON_PROPERTY_AT_BASE_TYPE,
        AttachmentRefFVO.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        AttachmentRefFVO.JSON_PROPERTY_ID,
        AttachmentRefFVO.JSON_PROPERTY_HREF,
        AttachmentRefFVO.JSON_PROPERTY_NAME,
        AttachmentRefFVO.JSON_PROPERTY_AT_REFERRED_TYPE,
        AttachmentRefFVO.JSON_PROPERTY_DESCRIPTION,
        AttachmentRefFVO.JSON_PROPERTY_URL
    })
@lombok.Data
@lombok.Builder
