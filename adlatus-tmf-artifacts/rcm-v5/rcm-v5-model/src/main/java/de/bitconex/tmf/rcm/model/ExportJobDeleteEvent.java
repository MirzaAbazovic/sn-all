...
import java.util.Arrays;
    ...
    import de.bitconex.tmf.rcm.model.ExportJobDeleteEventPayload;
...
*/
    @JsonPropertyOrder({
        ExportJobDeleteEvent.JSON_PROPERTY_AT_TYPE,
        ExportJobDeleteEvent.JSON_PROPERTY_AT_BASE_TYPE,
        ExportJobDeleteEvent.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ExportJobDeleteEvent.JSON_PROPERTY_HREF,
        ExportJobDeleteEvent.JSON_PROPERTY_ID,
        ExportJobDeleteEvent.JSON_PROPERTY_CORRELATION_ID,
        ExportJobDeleteEvent.JSON_PROPERTY_DOMAIN,
        ExportJobDeleteEvent.JSON_PROPERTY_TITLE,
        ExportJobDeleteEvent.JSON_PROPERTY_DESCRIPTION,
        ExportJobDeleteEvent.JSON_PROPERTY_PRIORITY,
        ExportJobDeleteEvent.JSON_PROPERTY_TIME_OCCURRED,
        ExportJobDeleteEvent.JSON_PROPERTY_SOURCE,
        ExportJobDeleteEvent.JSON_PROPERTY_REPORTING_SYSTEM,
        ExportJobDeleteEvent.JSON_PROPERTY_RELATED_PARTY,
        ExportJobDeleteEvent.JSON_PROPERTY_ANALYTIC_CHARACTERISTIC,
        ExportJobDeleteEvent.JSON_PROPERTY_EVENT_ID,
        ExportJobDeleteEvent.JSON_PROPERTY_EVENT_TIME,
        ExportJobDeleteEvent.JSON_PROPERTY_EVENT_TYPE,
        ExportJobDeleteEvent.JSON_PROPERTY_EVENT
    })
@lombok.Data
@lombok.Builder
