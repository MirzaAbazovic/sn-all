...
import java.util.Arrays;
    ...
    import com.fasterxml.jackson.annotation.*;
        ...
        /**
* ResourceCandidateCreateEvent generic structure
*/
    @JsonPropertyOrder({
        ResourceCandidateCreateEventAllOf.JSON_PROPERTY_EVENT
    })
            @JsonTypeName("ResourceCandidateCreateEvent_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class ResourceCandidateCreateEventAllOf {
