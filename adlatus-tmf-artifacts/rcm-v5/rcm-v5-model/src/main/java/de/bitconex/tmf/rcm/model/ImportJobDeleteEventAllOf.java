...
import java.util.Arrays;
    ...
    import com.fasterxml.jackson.annotation.*;
        ...
        /**
* ImportJobDeleteEvent generic structure
*/
    @JsonPropertyOrder({
        ImportJobDeleteEventAllOf.JSON_PROPERTY_EVENT
    })
            @JsonTypeName("ImportJobDeleteEvent_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class ImportJobDeleteEventAllOf {
