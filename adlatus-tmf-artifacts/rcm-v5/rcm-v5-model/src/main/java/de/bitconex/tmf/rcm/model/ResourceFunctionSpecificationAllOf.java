...
*/
    @JsonPropertyOrder({
        ResourceFunctionSpecificationAllOf.JSON_PROPERTY_CONNECTION_POINT_SPECIFICATION,
        ResourceFunctionSpecificationAllOf.JSON_PROPERTY_CONNECTIVITY_SPECIFICATION
    })
            @JsonTypeName("ResourceFunctionSpecification_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class ResourceFunctionSpecificationAllOf {
