...
*/
    @JsonPropertyOrder({
        ResourceCandidateStatusChangeEvent.JSON_PROPERTY_AT_TYPE,
        ResourceCandidateStatusChangeEvent.JSON_PROPERTY_AT_BASE_TYPE,
        ResourceCandidateStatusChangeEvent.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ResourceCandidateStatusChangeEvent.JSON_PROPERTY_HREF,
        ResourceCandidateStatusChangeEvent.JSON_PROPERTY_ID,
        ResourceCandidateStatusChangeEvent.JSON_PROPERTY_CORRELATION_ID,
        ResourceCandidateStatusChangeEvent.JSON_PROPERTY_DOMAIN,
        ResourceCandidateStatusChangeEvent.JSON_PROPERTY_TITLE,
        ResourceCandidateStatusChangeEvent.JSON_PROPERTY_DESCRIPTION,
        ResourceCandidateStatusChangeEvent.JSON_PROPERTY_PRIORITY,
        ResourceCandidateStatusChangeEvent.JSON_PROPERTY_TIME_OCCURRED,
        ResourceCandidateStatusChangeEvent.JSON_PROPERTY_SOURCE,
        ResourceCandidateStatusChangeEvent.JSON_PROPERTY_REPORTING_SYSTEM,
        ResourceCandidateStatusChangeEvent.JSON_PROPERTY_RELATED_PARTY,
        ResourceCandidateStatusChangeEvent.JSON_PROPERTY_ANALYTIC_CHARACTERISTIC,
        ResourceCandidateStatusChangeEvent.JSON_PROPERTY_EVENT_ID,
        ResourceCandidateStatusChangeEvent.JSON_PROPERTY_EVENT_TIME,
        ResourceCandidateStatusChangeEvent.JSON_PROPERTY_EVENT_TYPE,
        ResourceCandidateStatusChangeEvent.JSON_PROPERTY_EVENT
    })
@lombok.Data
@lombok.Builder
