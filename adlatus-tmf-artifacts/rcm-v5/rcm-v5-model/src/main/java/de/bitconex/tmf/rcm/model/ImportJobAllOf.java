...
*/
    @JsonPropertyOrder({
        ImportJobAllOf.JSON_PROPERTY_COMPLETION_DATE,
        ImportJobAllOf.JSON_PROPERTY_CONTENT_TYPE,
        ImportJobAllOf.JSON_PROPERTY_CREATION_DATE,
        ImportJobAllOf.JSON_PROPERTY_ERROR_LOG,
        ImportJobAllOf.JSON_PROPERTY_PATH,
        ImportJobAllOf.JSON_PROPERTY_STATUS,
        ImportJobAllOf.JSON_PROPERTY_URL,
        ImportJobAllOf.JSON_PROPERTY_ID
    })
            @JsonTypeName("ImportJob_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class ImportJobAllOf {
