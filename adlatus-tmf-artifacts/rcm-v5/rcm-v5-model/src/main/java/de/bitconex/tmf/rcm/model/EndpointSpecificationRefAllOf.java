...
*/
    @JsonPropertyOrder({
        EndpointSpecificationRefAllOf.JSON_PROPERTY_ROLE,
        EndpointSpecificationRefAllOf.JSON_PROPERTY_IS_ROOT,
        EndpointSpecificationRefAllOf.JSON_PROPERTY_CONNECTION_POINT_SPECIFICATION
    })
            @JsonTypeName("EndpointSpecificationRef_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class EndpointSpecificationRefAllOf {
