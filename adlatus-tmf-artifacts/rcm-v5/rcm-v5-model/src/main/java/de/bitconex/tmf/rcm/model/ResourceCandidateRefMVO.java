...
*/
    @JsonPropertyOrder({
        ResourceCandidateRefMVO.JSON_PROPERTY_AT_TYPE,
        ResourceCandidateRefMVO.JSON_PROPERTY_AT_BASE_TYPE,
        ResourceCandidateRefMVO.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ResourceCandidateRefMVO.JSON_PROPERTY_HREF,
        ResourceCandidateRefMVO.JSON_PROPERTY_ID,
        ResourceCandidateRefMVO.JSON_PROPERTY_NAME,
        ResourceCandidateRefMVO.JSON_PROPERTY_AT_REFERRED_TYPE,
        ResourceCandidateRefMVO.JSON_PROPERTY_VERSION
    })
@lombok.Data
@lombok.Builder
