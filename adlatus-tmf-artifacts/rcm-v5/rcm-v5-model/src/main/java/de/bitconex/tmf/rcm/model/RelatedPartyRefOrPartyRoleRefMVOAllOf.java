...
*/
    @JsonPropertyOrder({
        RelatedPartyRefOrPartyRoleRefMVOAllOf.JSON_PROPERTY_ROLE,
        RelatedPartyRefOrPartyRoleRefMVOAllOf.JSON_PROPERTY_PARTY_OR_PARTY_ROLE
    })
            @JsonTypeName("RelatedPartyRefOrPartyRoleRef_MVO_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class RelatedPartyRefOrPartyRoleRefMVOAllOf {
