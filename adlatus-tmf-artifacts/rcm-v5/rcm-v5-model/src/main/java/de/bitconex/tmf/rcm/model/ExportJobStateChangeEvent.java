...
import java.util.Arrays;
    ...
    import de.bitconex.tmf.rcm.model.ExportJobStateChangeEventPayload;
...
*/
    @JsonPropertyOrder({
        ExportJobStateChangeEvent.JSON_PROPERTY_AT_TYPE,
        ExportJobStateChangeEvent.JSON_PROPERTY_AT_BASE_TYPE,
        ExportJobStateChangeEvent.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ExportJobStateChangeEvent.JSON_PROPERTY_HREF,
        ExportJobStateChangeEvent.JSON_PROPERTY_ID,
        ExportJobStateChangeEvent.JSON_PROPERTY_CORRELATION_ID,
        ExportJobStateChangeEvent.JSON_PROPERTY_DOMAIN,
        ExportJobStateChangeEvent.JSON_PROPERTY_TITLE,
        ExportJobStateChangeEvent.JSON_PROPERTY_DESCRIPTION,
        ExportJobStateChangeEvent.JSON_PROPERTY_PRIORITY,
        ExportJobStateChangeEvent.JSON_PROPERTY_TIME_OCCURRED,
        ExportJobStateChangeEvent.JSON_PROPERTY_SOURCE,
        ExportJobStateChangeEvent.JSON_PROPERTY_REPORTING_SYSTEM,
        ExportJobStateChangeEvent.JSON_PROPERTY_RELATED_PARTY,
        ExportJobStateChangeEvent.JSON_PROPERTY_ANALYTIC_CHARACTERISTIC,
        ExportJobStateChangeEvent.JSON_PROPERTY_EVENT_ID,
        ExportJobStateChangeEvent.JSON_PROPERTY_EVENT_TIME,
        ExportJobStateChangeEvent.JSON_PROPERTY_EVENT_TYPE,
        ExportJobStateChangeEvent.JSON_PROPERTY_EVENT
    })
@lombok.Data
@lombok.Builder
