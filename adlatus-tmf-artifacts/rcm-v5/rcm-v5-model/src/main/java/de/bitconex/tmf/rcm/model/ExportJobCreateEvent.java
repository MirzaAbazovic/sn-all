...
import java.util.Arrays;
    ...
    import de.bitconex.tmf.rcm.model.ExportJobCreateEventPayload;
...
*/
    @JsonPropertyOrder({
        ExportJobCreateEvent.JSON_PROPERTY_AT_TYPE,
        ExportJobCreateEvent.JSON_PROPERTY_AT_BASE_TYPE,
        ExportJobCreateEvent.JSON_PROPERTY_AT_SCHEMA_LOCATION,
        ExportJobCreateEvent.JSON_PROPERTY_HREF,
        ExportJobCreateEvent.JSON_PROPERTY_ID,
        ExportJobCreateEvent.JSON_PROPERTY_CORRELATION_ID,
        ExportJobCreateEvent.JSON_PROPERTY_DOMAIN,
        ExportJobCreateEvent.JSON_PROPERTY_TITLE,
        ExportJobCreateEvent.JSON_PROPERTY_DESCRIPTION,
        ExportJobCreateEvent.JSON_PROPERTY_PRIORITY,
        ExportJobCreateEvent.JSON_PROPERTY_TIME_OCCURRED,
        ExportJobCreateEvent.JSON_PROPERTY_SOURCE,
        ExportJobCreateEvent.JSON_PROPERTY_REPORTING_SYSTEM,
        ExportJobCreateEvent.JSON_PROPERTY_RELATED_PARTY,
        ExportJobCreateEvent.JSON_PROPERTY_ANALYTIC_CHARACTERISTIC,
        ExportJobCreateEvent.JSON_PROPERTY_EVENT_ID,
        ExportJobCreateEvent.JSON_PROPERTY_EVENT_TIME,
        ExportJobCreateEvent.JSON_PROPERTY_EVENT_TYPE,
        ExportJobCreateEvent.JSON_PROPERTY_EVENT
    })
@lombok.Data
@lombok.Builder
