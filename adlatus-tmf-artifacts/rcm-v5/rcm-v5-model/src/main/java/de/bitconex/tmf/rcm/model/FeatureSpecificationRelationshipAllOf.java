...
*/
    @JsonPropertyOrder({
        FeatureSpecificationRelationshipAllOf.JSON_PROPERTY_RELATIONSHIP_TYPE,
        FeatureSpecificationRelationshipAllOf.JSON_PROPERTY_FEATURE_ID,
        FeatureSpecificationRelationshipAllOf.JSON_PROPERTY_PARENT_SPECIFICATION_ID,
        FeatureSpecificationRelationshipAllOf.JSON_PROPERTY_PARENT_SPECIFICATION_HREF,
        FeatureSpecificationRelationshipAllOf.JSON_PROPERTY_NAME,
        FeatureSpecificationRelationshipAllOf.JSON_PROPERTY_VALID_FOR
    })
            @JsonTypeName("FeatureSpecificationRelationship_allOf")
@lombok.Data
@lombok.Builder
@lombok.AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)

public class FeatureSpecificationRelationshipAllOf {
              /**
