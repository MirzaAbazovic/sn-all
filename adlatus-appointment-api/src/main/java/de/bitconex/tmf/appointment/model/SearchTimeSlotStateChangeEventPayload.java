...
@Schema(name = "SearchTimeSlotStateChangeEventPayload", description = "The event data structure")
...
public class SearchTimeSlotStateChangeEventPayload {

  private SearchTimeSlot searchTimeSlot;

  public SearchTimeSlotStateChangeEventPayload searchTimeSlot(SearchTimeSlot searchTimeSlot) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    SearchTimeSlotStateChangeEventPayload searchTimeSlotStateChangeEventPayload = (SearchTimeSlotStateChangeEventPayload) o;
    return Objects.equals(this.searchTimeSlot, searchTimeSlotStateChangeEventPayload.searchTimeSlot);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchTimeSlotStateChangeEventPayload {\n");
