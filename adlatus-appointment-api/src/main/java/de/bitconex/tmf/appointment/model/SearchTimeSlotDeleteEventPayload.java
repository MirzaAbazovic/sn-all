...
@Schema(name = "SearchTimeSlotDeleteEventPayload", description = "The event data structure")
...
public class SearchTimeSlotDeleteEventPayload {

  private SearchTimeSlot searchTimeSlot;

  public SearchTimeSlotDeleteEventPayload searchTimeSlot(SearchTimeSlot searchTimeSlot) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    SearchTimeSlotDeleteEventPayload searchTimeSlotDeleteEventPayload = (SearchTimeSlotDeleteEventPayload) o;
    return Objects.equals(this.searchTimeSlot, searchTimeSlotDeleteEventPayload.searchTimeSlot);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchTimeSlotDeleteEventPayload {\n");
