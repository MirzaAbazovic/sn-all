 ...
 */
import { ResourceSpecificationCreateEventPayload } from './resourceSpecificationCreateEventPayload';


/**
 * The notification data structure
 */
export interface ResourceSpecificationCreateEvent { 
    /**
     ...
     */
    event?: ResourceSpecificationCreateEventPayload;
}
