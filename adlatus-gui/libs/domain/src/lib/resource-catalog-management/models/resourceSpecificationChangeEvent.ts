 ...
 */
import { ResourceSpecificationChangeEventPayload } from './resourceSpecificationChangeEventPayload';


/**
 * The notification data structure
 */
export interface ResourceSpecificationChangeEvent { 
    /**
     ...
     */
    event?: ResourceSpecificationChangeEventPayload;
}
