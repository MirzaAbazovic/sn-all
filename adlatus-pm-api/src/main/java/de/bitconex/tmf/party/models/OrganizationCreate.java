...
public class OrganizationCreate {
    ...
    public OrganizationCreate atBaseType(String atBaseType) {
    ...
    public OrganizationCreate atSchemaLocation(URI atSchemaLocation) {
    ...
    public OrganizationCreate atType(String atType) {
        this.atType = atType;
        return this;
    }
