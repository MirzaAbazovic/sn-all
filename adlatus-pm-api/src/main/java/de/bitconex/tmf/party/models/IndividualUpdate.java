...
public class IndividualUpdate {
    ...
    public IndividualUpdate atBaseType(String atBaseType) {
    ...
    public IndividualUpdate atSchemaLocation(URI atSchemaLocation) {
    ...
    public IndividualUpdate atType(String atType) {
        this.atType = atType;
        return this;
    }
