...
public class ResourceCatalogCreate {
     ...
     * Default constructor
     *
     * @deprecated Use {@link ResourceCatalogCreate#ResourceCatalogCreate(String)}
     */
    @Deprecated
    public ResourceCatalogCreate() {
        super();
    }
     ...
     */
    public ResourceCatalogCreate(String name) {
        this.name = name;
    }
    ...
    public ResourceCatalogCreate category(List<@Valid ResourceCategoryRef> category) {
    ...
    public ResourceCatalogCreate relatedParty(List<@Valid RelatedParty> relatedParty) {
    ...
    public ResourceCatalogCreate atBaseType(String atBaseType) {
    ...
    public ResourceCatalogCreate atSchemaLocation(URI atSchemaLocation) {
    ...
    public ResourceCatalogCreate atType(String atType) {
        this.atType = atType;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.description, resourceCatalogCreate.description) &&
                ...
                Objects.equals(this.atBaseType, resourceCatalogCreate.atBaseType) &&
                Objects.equals(this.atSchemaLocation, resourceCatalogCreate.atSchemaLocation) &&
                Objects.equals(this.atType, resourceCatalogCreate.atType);
    }
