...
@Schema(name = "ResourceSpecification_Create", description = "Resources are physical or non-physical components (or some combination of these) within an enterprise's infrastructure or inventory. They are typically consumed or used by services (for example a physical port assigned to a service) or contribute to the realization of a Product (for example, a SIM card). They can be drawn from the Application, Computing and Network domains, and include, for example, Network Elements, software, IT systems, content and information, and technology components. A ResourceSpecification is a base class that represents a generic means for implementing a particular type of Resource. In essence, a ResourceSpecification defines the common attributes and relationships of a set of related Resources, while Resource defines a specific instance that is based on a particular ResourceSpecification. Skipped properties: id,href")
@JsonTypeName("ResourceSpecification_Create")
...
public class ResourceSpecificationCreate {
     ...
     * Default constructor
     *
     * @deprecated Use {@link ResourceSpecificationCreate#ResourceSpecificationCreate(String)}
     */
    @Deprecated
     ...
     */
    public ResourceSpecificationCreate(String name) {
        this.name = name;
    }
    ...
    public ResourceSpecificationCreate attachment(List<@Valid AttachmentRefOrValue> attachment) {
        this.attachment = attachment;
        return this;
    }

    public ResourceSpecificationCreate addAttachmentItem(AttachmentRefOrValue attachmentItem) {
    ...
    public ResourceSpecificationCreate featureSpecification(List<@Valid FeatureSpecification> featureSpecification) {
        this.featureSpecification = featureSpecification;
        return this;
    }

    public ResourceSpecificationCreate addFeatureSpecificationItem(FeatureSpecification featureSpecificationItem) {
    ...
    public ResourceSpecificationCreate relatedParty(List<@Valid RelatedParty> relatedParty) {
    ...
    public ResourceSpecificationCreate resourceSpecCharacteristic(List<@Valid ResourceSpecificationCharacteristic> resourceSpecCharacteristic) {
        this.resourceSpecCharacteristic = resourceSpecCharacteristic;
        return this;
    }

    public ResourceSpecificationCreate addResourceSpecCharacteristicItem(ResourceSpecificationCharacteristic resourceSpecCharacteristicItem) {
    ...
    public ResourceSpecificationCreate resourceSpecRelationship(List<@Valid ResourceSpecificationRelationship> resourceSpecRelationship) {
        this.resourceSpecRelationship = resourceSpecRelationship;
        return this;
    }

    public ResourceSpecificationCreate addResourceSpecRelationshipItem(ResourceSpecificationRelationship resourceSpecRelationshipItem) {
    ...
    public ResourceSpecificationCreate targetResourceSchema(TargetResourceSchema targetResourceSchema) {
    ...
    public ResourceSpecificationCreate atBaseType(String atBaseType) {
    ...
    public ResourceSpecificationCreate atSchemaLocation(URI atSchemaLocation) {
    ...
    public ResourceSpecificationCreate atType(String atType) {
        this.atType = atType;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.category, resourceSpecificationCreate.category) &&
                ...
                Objects.equals(this.atBaseType, resourceSpecificationCreate.atBaseType) &&
                Objects.equals(this.atSchemaLocation, resourceSpecificationCreate.atSchemaLocation) &&
                Objects.equals(this.atType, resourceSpecificationCreate.atType);
    }
