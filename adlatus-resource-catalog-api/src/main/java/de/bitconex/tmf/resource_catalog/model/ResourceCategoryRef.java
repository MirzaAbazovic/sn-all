...
@Schema(name = "ResourceCategoryRef", description = "The (resource) category resource is used to group resource candidates in logical containers. Categories can contain other categories.")
...
public class ResourceCategoryRef {
  ...
  /**
   * Default constructor
   * @deprecated Use {@link ResourceCategoryRef#ResourceCategoryRef(String)}
   */
  @Deprecated
   ...
   */
  public ResourceCategoryRef(String id) {
    this.id = id;
  }
  ...
  */
  ...
  public ResourceCategoryRef href(URI href) {
    this.href = href;
    return this;
  }
  ...
  */
  ...
  public ResourceCategoryRef atBaseType(String atBaseType) {
  ...
  */
  ...
  public ResourceCategoryRef atSchemaLocation(URI atSchemaLocation) {
  ...
  */
  ...
  public ResourceCategoryRef atReferredType(String atReferredType) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, resourceCategoryRef.id) &&
        ...
        Objects.equals(this.atType, resourceCategoryRef.atType) &&
