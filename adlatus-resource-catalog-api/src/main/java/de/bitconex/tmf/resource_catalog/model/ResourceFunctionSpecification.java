...
@Schema(name = "ResourceFunctionSpecification", description = "Specifies a function as a behavior to transform inputs of any nature into outputs of any nature independently from the way it is provided, for example a Medium to Large Enterprise Firewall.")
...
public class ResourceFunctionSpecification {
  ...
  @Valid
  private List<@Valid ConnectionPointSpecificationRef> connectionPointSpecification;

  @Valid
  private List<@Valid ResourceGraphSpecification> connectivitySpecification;
  ...
  */
  ...
  public ResourceFunctionSpecification connectionPointSpecification(List<@Valid ConnectionPointSpecificationRef> connectionPointSpecification) {
  ...
  */
  ...
  public List<@Valid ConnectionPointSpecificationRef> getConnectionPointSpecification() {
    return connectionPointSpecification;
  }

  public void setConnectionPointSpecification(List<@Valid ConnectionPointSpecificationRef> connectionPointSpecification) {
    this.connectionPointSpecification = connectionPointSpecification;
  }

  public ResourceFunctionSpecification connectivitySpecification(List<@Valid ResourceGraphSpecification> connectivitySpecification) {
  ...
  */
  ...
  public List<@Valid ResourceGraphSpecification> getConnectivitySpecification() {
    return connectivitySpecification;
  }

  public void setConnectivitySpecification(List<@Valid ResourceGraphSpecification> connectivitySpecification) {
    this.connectivitySpecification = connectivitySpecification;
  }

  public ResourceFunctionSpecification featureSpecification(List<@Valid FeatureSpecification> featureSpecification) {
  ...
  */
  ...
  public ResourceFunctionSpecification relatedParty(List<@Valid RelatedParty> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ResourceFunctionSpecification addRelatedPartyItem(RelatedParty relatedPartyItem) {
  ...
  */
  ...
  public ResourceFunctionSpecification resourceSpecCharacteristic(List<@Valid ResourceSpecificationCharacteristic> resourceSpecCharacteristic) {
    this.resourceSpecCharacteristic = resourceSpecCharacteristic;
    return this;
  }

  public ResourceFunctionSpecification addResourceSpecCharacteristicItem(ResourceSpecificationCharacteristic resourceSpecCharacteristicItem) {
  ...
  */
  ...
  public ResourceFunctionSpecification resourceSpecRelationship(List<@Valid ResourceSpecificationRelationship> resourceSpecRelationship) {
  ...
  */
  ...
  public ResourceFunctionSpecification atSchemaLocation(URI atSchemaLocation) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, resourceFunctionSpecification.id) &&
        ...
        Objects.equals(this.connectionPointSpecification, resourceFunctionSpecification.connectionPointSpecification) &&
        ...
        Objects.equals(this.resourceSpecCharacteristic, resourceFunctionSpecification.resourceSpecCharacteristic) &&
        ...
        Objects.equals(this.atBaseType, resourceFunctionSpecification.atBaseType) &&
        Objects.equals(this.atSchemaLocation, resourceFunctionSpecification.atSchemaLocation) &&
        Objects.equals(this.atType, resourceFunctionSpecification.atType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, href, category, description, isBundle, lastUpdate, lifecycleStatus, name, version, attachment, connectionPointSpecification, connectivitySpecification, featureSpecification, relatedParty, resourceSpecCharacteristic, resourceSpecRelationship, targetResourceSchema, validFor, atBaseType, atSchemaLocation, atType);
  }
