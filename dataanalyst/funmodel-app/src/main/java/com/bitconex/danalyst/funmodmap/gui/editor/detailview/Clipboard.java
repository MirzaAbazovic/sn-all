...
public class Clipboard {
    ...
    public boolean select (SelectableNode n) {
        boolean selected = !selectedItems.contains(n);
        return select(n, selected);
    }
    private boolean select(SelectableNode n, boolean selected) {
