INSERT INTO GUICOMPONENT (ID, NAME, PARENT, TYPE, DESCRIPTION, APP_ID, VERSION) VALUES
    (S_GUICOMPONENT_0.NEXTVAL, 'save', 'de.augustakom.hurrican.gui.base.tree.hardware.EditRangierungPanel',
    'Button', 'Button zum Speichern der modifizierten Rangierungen', 1, 0);
