-- Ermittlung aller Projektierungen
create or replace view V_HURRICAN_PROJEKTIERUNG as
...
GRANT SELECT ON V_HURRICAN_PROJEKTIERUNG TO HURRICAN_TECH_MUC;

-- Ermittlung der Detail-Datensaetze zu den Projektierungen
create or replace view V_HURRICAN_PROJ_DETAILS as
select va.*, ABT.TEXT as ABTEILUNG from t_verlauf_abteilung va,
 V_HURRICAN_PROJEKTIERUNG P,
 T_ABTEILUNG abt 
 where P.VERLAUF_ID=VA.VERLAUF_ID
 and VA.ABTEILUNG_ID=ABT.ID;

GRANT SELECT ON V_HURRICAN_PROJ_DETAILS TO HURRICAN_TECH_MUC; 
