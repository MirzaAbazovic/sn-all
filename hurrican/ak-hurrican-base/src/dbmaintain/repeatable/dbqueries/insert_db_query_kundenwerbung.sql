...
delete from T_DB_QUERIES where NAME = 'Kundenwerbung-Gutschriften';
delete from T_DB_QUERIES where ID=191;

insert into T_DB_QUERIES (ID, NAME, DESCRIPTION, SERVICE, SQL_QUERY)
  values (191, 'Kundenwerbung-Gutschriften', 'Ermittlung falsch eingetragener Kundenwerbung-Gutschriften.',
  'BILLING',
  'SELECT P.ORDER__NO,
         a.CUST_NO,
    ...
    FROM    LEISTUNG l
         ...
         JOIN OE oe on l.OE__NO = oe.OE__NO AND OE.HIST_LAST = 1
