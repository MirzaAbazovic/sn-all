-- Produkt2PhysikTyp fuer 'ADSL2+ only MS (H)' anlegen (analog zu 'ADSL2+ only (H)')
CREATE OR REPLACE PROCEDURE mig_p2pt_4_adbf2_only
IS
BEGIN
   DECLARE
      physiktyp_adbf1   CONSTANT NUMBER (19) := 514;
      physiktyp_adbf2   CONSTANT NUMBER (19) := 517;
...
CALL mig_p2pt_4_adbf2_only ();

DROP PROCEDURE mig_p2pt_4_adbf2_only;