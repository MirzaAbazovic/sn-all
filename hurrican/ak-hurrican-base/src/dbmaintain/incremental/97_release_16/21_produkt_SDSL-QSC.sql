...
(PROD_ID, PRODUKTGRUPPE_ID, ANSCHLUSSART, PROD_NAME_PATTERN, AKTIONS_ID,
 ...
 SMS_VERSAND)
Values
  (448, 8, 'SDSL-QSC', 'SDSL-QSC {REALVARIANTE} {DOWNSTREAM}', 1,
   2, '0', 60, TO_DATE('08/01/2014 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('01/01/2200 00:00:00', 'MM/DD/YYYY HH24:MI:SS'),
   '0', '1', '0', '1', 1,
    ...
    FOR p2s IN (select * from T_PRODUKT_2_TECH_LOCATION_TYPE p where p.PROD_ID = prod_id_src) LOOP
      ...
      VALUES
        (S_T_PRODUKT_2_TECH_LOC_TYPE_0.nextval, prod_id_dest, p2s.TECH_LOCATION_TYPE_REF_ID, p2s.priority,
         'dbmaintain', TO_DATE('08/01/2014 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 0)
    ;
    END LOOP;
  END;
/
...
call clone_prod_2_tech_loc_type(441, 448);
...
call clone_report_2_prod(441, 448);
