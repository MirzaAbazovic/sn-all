-- SQL-Query fuer RFC-201 (Taifun Auftraege von Haendler online bestellt, ohne Gutschriftsleistung)
Insert into T_DB_QUERIES
 ...
 Values
   ...
   'BILLING',
   'select CUSTOMER.CUST_NO as HAENDLER_NO, CUSTOMER.FIRSTNAME as HAENDLER_NAME, CUSTOMER.FIRSTNAME as HAENDLER_VORNAME,
