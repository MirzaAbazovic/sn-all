...
VALUES
  (S_T_HW_BAUGRUPPEN_TYP_0.nextVal, 'MA5811S AE04', 4, 'Huawei MA5811S AE08 mit 4 Ports', '1', 'GFAST', 'DPU',
...
INSERT INTO T_HW_BAUGRUPPEN_TYP (ID, NAME, PORT_COUNT, DESCRIPTION, IS_ACTIVE, HW_SCHNITTSTELLE_NAME, HW_TYPE_NAME,
                                 ...
                                 MAX_BANDWIDTH_UPSTREAM, BONDING_CAPABLE)
VALUES
  (S_T_HW_BAUGRUPPEN_TYP_0.nextVal, 'MA5811S AE08', 8, 'Huawei MA5811S AE08 mit 8 Ports', '1', 'GFAST', 'DPU',
   2, 0, NULL, NULL, 150000, 100000, '0');
...
INSERT INTO T_HW_BAUGRUPPEN_TYP (ID, NAME, PORT_COUNT, DESCRIPTION, IS_ACTIVE, HW_SCHNITTSTELLE_NAME, HW_TYPE_NAME,
                                 ...
                                 MAX_BANDWIDTH_UPSTREAM, BONDING_CAPABLE)
VALUES
  (S_T_HW_BAUGRUPPEN_TYP_0.nextVal, 'MA5811S DE16', 16, 'Huawei MA5811S DE16 mit 16 Ports', '1', 'GFAST', 'DPU',
   2, 0, NULL, NULL, 150000, 100000, '0');
...
VALUES
  (S_T_HW_BG_TYP_2_PHYSIK_TYP_0.nextval, (SELECT
                                          ...
                                          WHERE bgt.name = 'MA5811S AE04'), 810, 0);
...
VALUES
  (S_T_HW_BG_TYP_2_PHYSIK_TYP_0.nextval, (SELECT
                                            bgt.id
                                          FROM T_HW_BAUGRUPPEN_TYP bgt
                                          WHERE bgt.name = 'MA5811S AE08'), 810, 0);
...
VALUES
  (S_T_HW_BG_TYP_2_PHYSIK_TYP_0.nextval, (SELECT
                                            bgt.id
                                          FROM T_HW_BAUGRUPPEN_TYP bgt
                                          WHERE bgt.name = 'MA5811S DE16'), 810, 0);
