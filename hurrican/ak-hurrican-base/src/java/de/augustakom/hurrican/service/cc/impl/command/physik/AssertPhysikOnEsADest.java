 ...
 */
@CcTxRequired
@Component("de.augustakom.hurrican.service.cc.impl.command.physik.AssertPhysikOnEsADest")
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class AssertPhysikOnEsADest extends AssertPhysikOnEsDest {
    ...
    public Object executeAfterFlush() throws Exception {
        if (!hasPhysik(getAuftragIdDest(), Endstelle.ENDSTELLEN_TYP_A)) {
            throw generateException(Endstelle.ENDSTELLEN_TYP_A, true);
        }
        return null;
    }
