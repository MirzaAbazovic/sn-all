 ...
 *
 */
public class IstQuellRangierungFreiFuerPortkonzentrationImpl implements IstRangierungFreiFuerPortkonzentration {
    public IstQuellRangierungFreiFuerPortkonzentrationImpl(CCAuftragService auftragService) {
    ...
    private boolean rangierungIstFreiFuerPortkonzentration(Rangierung rangierung) throws FindException {
        ...
        if (rangierung == null) {
            ...
            if (rangierung.getEsId() == null || Rangierung.Freigegeben.WEPLA.equals(rangierung.getFreigegeben())) {
                rangierungIstFrei = true;
            }
            else if (Rangierung.RANGIERUNG_NOT_ACTIVE.equals(rangierung.getEsId())) {
    ...
    public Boolean apply(@Nullable Rangierung input) {
        try {
            return rangierungIstFreiFuerPortkonzentration(input);
        }
