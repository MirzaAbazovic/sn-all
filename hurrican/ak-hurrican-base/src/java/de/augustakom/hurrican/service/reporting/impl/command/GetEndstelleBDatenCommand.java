 ...
 *
 */
public class GetEndstelleBDatenCommand extends AbstractEndstelleDatenCommand {

    private static final Logger LOGGER = Logger.getLogger(GetEndstelleBDatenCommand.class);
