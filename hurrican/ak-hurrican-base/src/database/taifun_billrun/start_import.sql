delete from RTB_BILL_200610;
delete from A_PRICE_SUM_200610;
delete from RTB_BILL_ITEM_200610;

load data local infile "./RTB_BILL_200610.txt" into table RTB_BILL_200610
FIELDS TERMINATED BY ';' ENCLOSED BY '' ESCAPED BY '\\'
LINES TERMINATED BY '\n';

load data local infile "./A_PRICE_SUM_200610.txt" into table A_PRICE_SUM_200610
FIELDS TERMINATED BY ';' ENCLOSED BY '' ESCAPED BY '\\'
LINES TERMINATED BY '\n';

load data local infile "./RTB_BILL_ITEM_200610.txt" into table RTB_BILL_ITEM_200610
FIELDS TERMINATED BY ';' ENCLOSED BY '' ESCAPED BY '\\'
LINES TERMINATED BY '\n';
...
update RTB_BILL_ITEM_200610 set CHARGED_FROM=null where CHARGED_FROM='0000-00-00';
update RTB_BILL_ITEM_200610 set CHARGED_TO=null where CHARGED_TO='0000-00-00';
