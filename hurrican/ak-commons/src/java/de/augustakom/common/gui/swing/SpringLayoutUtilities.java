 ...
 * All rights reserved.
 * -------------------------------------------------------
 * File created: 15.04.2005 08:06:57
 */
 ...
 * <p/>
 * Note: Copied from the JFC-Swing Tutorial!
 */
public class SpringLayoutUtilities {

    private static final Logger LOGGER = Logger.getLogger(SpringLayoutUtilities.class);
    ...
    public static void makeGrid(Container parent, Component[] components, boolean makeCompact,
        ...
        if (makeCompact) {
            ...
            makeGrid(parent, rows, cols, initialX, initialY, xPad, yPad);
        }
    }
