...
/**
 * AK-Implementierung einer JTextArea.
 *
 *
 */
public class AKJTextArea extends JTextArea implements AKColorChangeableComponent,
    ...
    /**
     * Erzeugt eine neue TextArea mit der definierten Anzahl an Zeilen und Spalten.
     *
     * @param rows
     * @param columns
     */
    public AKJTextArea(int rows, int columns) {
        super(rows, columns);
        init();
    }

    /**
     * Erzeugt eine neue TextArea mit dem definierten Text.
     *
     * @param text
     */
    public AKJTextArea(String text) {
        super(text);
        init();
    }

    /**
     * Erzeugt eine neue TextArea mit dem definierten Text und der definierten Anzahl an Zeilen und Spalten.
     *
     * @param text
     * @param rows
     * @param columns
     */
    public AKJTextArea(String text, int rows, int columns) {
        super(text, rows, columns);
        init();
    }

    /**
     * Erzeugt eine neue TextArea mit dem angegebenen Document.
     *
     * @param doc
     */
    public AKJTextArea(Document doc) {
        super(doc);
        init();
    }

    /**
     * Erzeugt eine neue TextArea mit Document, Text und Anzahl der Zeilen sowie Spalten.
     *
     * @param doc
     * @param text
     * @param rows
     * @param columns
     */
    public AKJTextArea(Document doc, String text, int rows, int columns) {
    ...
    private void init() {
        // JTextField und JTextArea besitzen unterschiedliche Schriftgroessen
