...
/**
 * IP Hilfsklasse. <br><br> Codebase is provided from BSI!
 */
public class IPAddressUtil {
    ...
    /**
     * Convert IPv6 presentation level address to network order binary form. credit: Converted from C code from Solaris
     * 8 (inet_pton)
     * <p/>
    ...
    private static boolean isIPv4MappedAddress(byte[] addr) {
        return addr.length >= INADDR16SZ && (addr[0] == 0x00) && (addr[1] == 0x00) && (addr[2] == 0x00)
