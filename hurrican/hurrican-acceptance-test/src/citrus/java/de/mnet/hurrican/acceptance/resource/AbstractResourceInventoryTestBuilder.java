 ...
 *
 */
public abstract class AbstractResourceInventoryTestBuilder extends AbstractHurricanTestBuilder {


    protected void simulatorUseCase(SimulatorUseCase useCase) {
        simulatorUseCase(useCase, ResourceInventoryTestVersion.V1);
    }
}
