...
public class VaKueOrnAbgStandardAblauf_Test extends AbstractWbciAcceptanceTestBuilder {
    ...
    /**
     * Tests the typical KUEORN use-case with all configured {@link CarrierCode}s (except M-net):
     * <p/>
     * <p/>
     * 
     * <pre>
    ...
    public void VaKueOrnAbgStandardAblauf_01_Test(ITestContext testContext, CarrierCode carrierCode) {
    ...
    protected void configure() {
        simulatorUseCase(WbciSimulatorUseCase.VaKueOrnAbgStandardAblauf_01, wbciCdmVersion, wbciVersion, geschaeftsfallTyp);
