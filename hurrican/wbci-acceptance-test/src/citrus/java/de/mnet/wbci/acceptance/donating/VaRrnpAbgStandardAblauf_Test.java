...
public class VaRrnpAbgStandardAblauf_Test extends AbstractWbciAcceptanceTestBuilder {
    ...
    /**
     * Tests the typical RRNP use-case with all configured {@link CarrierCode}s (except M-net):
     * <p/>
     * <p/>
     * 
     * <pre>
    ...
    public void VaRrnpAbgStandardAblauf_01_Test(ITestContext testContext, CarrierCode carrierCode) {
    ...
    protected void configure() {
        simulatorUseCase(WbciSimulatorUseCase.VaRrnpAbgStandardAblauf_01, wbciCdmVersion, wbciVersion, geschaeftsfallTyp);
