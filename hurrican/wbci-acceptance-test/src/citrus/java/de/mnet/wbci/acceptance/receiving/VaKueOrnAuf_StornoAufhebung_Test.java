...
public class VaKueOrnAuf_StornoAufhebung_Test extends AbstractWbciAcceptanceTestBuilder {
     ...
     */
    @CitrusTest
    public void VaKueOrnAuf_StornoAufhebung_01_Test() {
        simulatorUseCase(WbciSimulatorUseCase.VaKueOrnAuf_StornoAufhebung_01, wbciCdmVersion, wbciVersion,
                geschaeftsfallTyp);
     ...
     */
    @CitrusTest
    public void VaKueOrnAuf_StornoAufhebung_02_Test() {
        simulatorUseCase(WbciSimulatorUseCase.VaKueOrnAuf_StornoAufhebung_02, wbciCdmVersion, wbciVersion,
                geschaeftsfallTyp);
        ...
        hurrican().assertIoArchiveEntryCreated(IOType.IN, VA_KUE_ORN, MeldungTyp.ABBM);
