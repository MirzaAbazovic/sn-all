...
public class VaKueMrnAufStandardAblauf_Test extends AbstractWbciAcceptanceTestBuilder {
    ...
    public void VaKueMrnAufStandardAblauf_01_Test(ITestContext testContext, CarrierCode carrierCode) {
    ...
    protected void configure() {
        simulatorUseCase(WbciSimulatorUseCase.VaKueMrnAufStandardAblauf_01, wbciCdmVersion, wbciVersion, geschaeftsfallTyp);
