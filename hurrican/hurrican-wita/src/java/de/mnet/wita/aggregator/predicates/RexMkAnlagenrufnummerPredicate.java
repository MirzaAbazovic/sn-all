...
/**
 * Predicate-Implementierung ueberprueft, ob in dem {@link Auftrag} Objekt eine Anlagenrufnummer enthalten ist.
 */
public class RexMkAnlagenrufnummerPredicate implements Predicate<Auftrag> {
