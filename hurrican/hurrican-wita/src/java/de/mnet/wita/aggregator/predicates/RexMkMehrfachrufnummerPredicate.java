...
/**
 * Predicate-Implementierung ueberprueft, ob in dem {@link Auftrag} Objekt eine Mehrfachrufnummer enthalten ist.
 */
public class RexMkMehrfachrufnummerPredicate implements Predicate<Auftrag> {
    ...
    public boolean apply(Auftrag input) {
        ...
        if ((portierung instanceof RufnummernPortierungEinzelanschluss) && ((RufnummernPortierungEinzelanschluss) portierung).isMultipleDn()) {
            return true;
        }
