...
import de.mnet.esb.cdm.supplierpartner.lineorderservice.v1.AnsprechpartnerRolleType;
...
public class MwfToWitaConverter {
    // @formatter:off
    ...
    private static final ImmutableMap<GeschaeftsfallTyp, GeschaeftsfallEnumType> mwfToWitaGeschaeftsfall
            = ImmutableMap.<GeschaeftsfallTyp, GeschaeftsfallEnumType>builder()
                    ...
                    .put(GeschaeftsfallTyp.RUFNUMMERNEXPORT_ANSCHLUSSKUENDIGUNG, GeschaeftsfallEnumType.REX_MK)
