...
@Component("witaMessageMarshallerV2")
public class MessageMarshallerV2 implements Marshaller {

    @Resource(name = "jaxb2MarshallerLineOrderServiceV2")
    private Jaxb2Marshaller marshaller;

    @Autowired
    private CreateOrderMarshallerV2 createOrderMarshaller;
    @Autowired
    private CancelOrderMarshallerV2 cancelOrderMarshaller;
    @Autowired
    private RescheduleOrderMarshallerV2 rescheduleOrderMarshaller;
    @Autowired
    private UpdateOrderMarshallerV2 updateOrderMarshaller;
