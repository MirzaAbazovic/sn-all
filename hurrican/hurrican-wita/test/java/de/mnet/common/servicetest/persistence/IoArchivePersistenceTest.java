 ...
 */
package de.mnet.common.servicetest.persistence;
...
public class IoArchivePersistenceTest extends AbstractServiceTest {
    ...
    public void testPersist(int requestXmlLength) throws Exception {
        ...
        IoArchive ioArchive = ioArchiveBuilderProvider.get().withRequestXml(requestXml)
                ...
                .withRequestTimestamp(LocalDateTime.of(2011, 05, 29, 9, 28, 13, 0))
                .build();
        ...
        assertEquals(ioArchiveFromDb.getTimestampSent().getTime(), ioArchive.getTimestampSent().getTime());
