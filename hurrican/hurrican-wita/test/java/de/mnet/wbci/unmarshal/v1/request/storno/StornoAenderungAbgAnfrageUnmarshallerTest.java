...
import de.mnet.wbci.model.builder.cdm.carriernegotiation.v1.StornoAenderungEKPabgTypeTestBuilder;
...
public class StornoAenderungAbgAnfrageUnmarshallerTest {
    @Mock
    ...
    @InjectMocks
    private StornoAenderungAbgAnfrageUnmarshaller testling = new StornoAenderungAbgAnfrageUnmarshaller();
    ...
    public void testApply() throws Exception {
        StornoAenderungEKPabgType input = new StornoAenderungEKPabgTypeTestBuilder().buildValid();
        StornoAenderungAbgAnfrage anfrage = testling.apply(input);
        ...
        Assert.assertEquals(anfrage.getTyp(), RequestTyp.STR_AEN_ABG);
        ...
        Assert.assertEquals(anfrage.getAbsender(), absender);
    }
}
