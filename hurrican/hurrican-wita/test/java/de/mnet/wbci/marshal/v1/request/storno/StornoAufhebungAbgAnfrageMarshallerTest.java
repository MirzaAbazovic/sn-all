...
public class StornoAufhebungAbgAnfrageMarshallerTest {
    ...
    @InjectMocks
    private StornoAufhebungAbgAnfrageMarshaller testling = new StornoAufhebungAbgAnfrageMarshaller();
    ...
    public void testApply() throws Exception {
        ...
        StornoAufhebungEKPabgType result = testling.apply(stornoAnfrage);
