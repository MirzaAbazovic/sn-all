 ...
 *
 */
public class RufnummernportierungMeldungTypeAnlageTestBuilder extends RufnummernportierungMeldungTypeBuilder implements
    ...
    public RufnummernportierungMeldungType buildValid(GeschaeftsfallEnumType geschaeftsfallEnumType) {
        if (objectType.getPortierungRufnummern() == null && objectType.getPortierungRufnummernbloecke() == null) {
            withPortierungRufnummernbloecke(new PortierungRufnummernbloeckeMeldungMeldungTypeTestBuilder()
