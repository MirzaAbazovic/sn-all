...
import de.mnet.wita.model.builder.cdm.lineordernotificationservice.v2.ErlmJaxbBuilder;
import de.mnet.wita.unmarshal.v2.ErlmUnmarshallerV2;

@SuppressWarnings("Duplicates")
@Test(groups = UNIT)
public class ErlmUnmarshallerTest extends BaseTest {

    private final ErlmUnmarshallerV2 erlmUnmarshaller = new ErlmUnmarshallerV2();
