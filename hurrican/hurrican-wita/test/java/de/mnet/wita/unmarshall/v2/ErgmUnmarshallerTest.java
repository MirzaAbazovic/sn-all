...
import de.mnet.wita.model.builder.cdm.lineordernotificationservice.v2.ErgmJaxbBuilder;
import de.mnet.wita.unmarshal.v2.ErgmUnmarshallerV2;

@Test(groups = UNIT)
public class ErgmUnmarshallerTest extends BaseTest {

    private final ErgmUnmarshallerV2 ergmUnmarshaller = new ErgmUnmarshallerV2();
