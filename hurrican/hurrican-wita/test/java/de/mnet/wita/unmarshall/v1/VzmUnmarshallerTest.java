...
import de.mnet.wita.model.builder.cdm.lineordernotificationservice.v1.VzmJaxbBuilder;
import de.mnet.wita.unmarshal.v1.VzmUnmarshaller;

@Test(groups = UNIT)
public class VzmUnmarshallerTest {

    private final VzmUnmarshaller vzmUnmarshaller = new VzmUnmarshaller();
