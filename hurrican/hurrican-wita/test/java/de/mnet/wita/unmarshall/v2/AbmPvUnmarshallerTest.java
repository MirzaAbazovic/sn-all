...
import de.mnet.wita.model.builder.cdm.lineordernotificationservice.v2.AbmPvJaxbBuilder;
import de.mnet.wita.unmarshal.v2.AbmPvUnmarshallerV2;

@SuppressWarnings("Duplicates")
@Test(groups = BaseTest.UNIT)
public class AbmPvUnmarshallerTest extends BaseTest {

    private final AbmPvUnmarshallerV2 underTest = new AbmPvUnmarshallerV2();
