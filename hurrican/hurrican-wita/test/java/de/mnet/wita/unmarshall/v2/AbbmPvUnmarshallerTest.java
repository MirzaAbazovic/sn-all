...
import de.mnet.wita.model.builder.cdm.lineordernotificationservice.v2.AbbmPvJaxbBuilder;
import de.mnet.wita.unmarshal.v2.AbbmPvUnmarshallerV2;

@SuppressWarnings("Duplicates")
@Test(groups = UNIT)
public class AbbmPvUnmarshallerTest extends BaseTest {

    private final AbbmPvUnmarshallerV2 underTest = new AbbmPvUnmarshallerV2();
