...
import de.mnet.wita.model.builder.cdm.lineordernotificationservice.v2.MeldungsattributeMTAMTypeBuilder;
import de.mnet.wita.model.builder.cdm.lineordernotificationservice.v2.MeldungspositionTypeBuilder;
import de.mnet.wita.model.builder.cdm.lineordernotificationservice.v2.MeldungstypMTAMTypeBuilder;
import de.mnet.wita.unmarshal.v2.MTamUnmarshallerV2;
...
public class MTamUnmarshallerTest extends BaseTest {
    ...
    public void testMTAM() throws Exception {
        ...
        WitaMessage witaMessage = new MTamUnmarshallerV2().apply(meldung);
