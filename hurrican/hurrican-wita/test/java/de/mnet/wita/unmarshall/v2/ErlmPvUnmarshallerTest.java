...
import de.mnet.wita.model.builder.cdm.lineordernotificationservice.v2.ErlmPvJaxbBuilder;
import de.mnet.wita.unmarshal.v2.ErlmPvUnmarshallerV2;

@SuppressWarnings("Duplicates")
@Test(groups = UNIT)
public class ErlmPvUnmarshallerTest extends BaseTest {

    private final ErlmPvUnmarshallerV2 erlmPvUnmarshaller = new ErlmPvUnmarshallerV2();
