...
public class MessageUnmarshallerTest extends AbstractTestNGSpringContextTests {
    ...
    @Autowired
    protected MessageUnmarshaller messageUnmarshaller;

    @DataProvider
    public Object[][] dataProviderShouldUnmarshallMeldung() {
        return new Object[][] {
                { "soap-request/v7/valid-abbm.xml", AbbruchMeldung.class },
                { "soap-request/v7/valid-abm.xml", AuftragsBestaetigungsMeldung.class },
                { "soap-request/v7/valid-entm.xml", EntgeltMeldung.class },
                { "soap-request/v7/valid-erlm.xml", ErledigtMeldung.class },
                { "soap-request/v7/valid-mtam.xml", TerminAnforderungsMeldung.class },
                { "soap-request/v7/valid-qeb.xml", QualifizierteEingangsBestaetigung.class },
                { "soap-request/v7/valid-tam.xml", TerminAnforderungsMeldung.class },
                { "soap-request/v7/valid-vzm.xml", VerzoegerungsMeldung.class }
        };
    }
