...
import de.mnet.wita.model.builder.cdm.lineordernotificationservice.v2.EntmPvJaxbBuilder;
import de.mnet.wita.unmarshal.v2.EntmPvUnmarshallerV2;

@SuppressWarnings("Duplicates")
@Test(groups = UNIT)
public class EntmPvUnmarshallerTest extends BaseTest {

    private final EntmPvUnmarshallerV2 entmPvUnmarshaller = new EntmPvUnmarshallerV2();
