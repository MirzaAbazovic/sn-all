...
import de.mnet.wita.model.builder.cdm.lineordernotificationservice.v2.EntmJaxbBuilder;
import de.mnet.wita.unmarshal.v2.EntmUnmarshallerV2;

@Test(groups = UNIT)
public class EntmUnmarshallerTest extends BaseTest {

    private final EntmUnmarshallerV2 entmUnmarshaller = new EntmUnmarshallerV2();
