...
import de.mnet.wita.model.builder.cdm.lineordernotificationservice.v1.MeldungsattributeTAMTypeBuilder;
import de.mnet.wita.model.builder.cdm.lineordernotificationservice.v1.MeldungspositionTypeBuilder;
import de.mnet.wita.model.builder.cdm.lineordernotificationservice.v1.MeldungstypTAMTypeBuilder;
import de.mnet.wita.unmarshal.v1.TamUnmarshaller;
...
public class TamUnmarshallerTest extends BaseTest {
    ...
    public void testTAM() throws Exception {
        ...
        WitaMessage witaMessage = new TamUnmarshaller().apply(meldung);
