...
public class HvtTalPredicateTest extends BaseTest {

    private HvtTalPredicate cut;

    @BeforeMethod
    public void setUp() {
        cut = new HvtTalPredicate();
    }

    @DataProvider
    public Object[][] data() {
        Auftrag auftrag1 = new AuftragBuilder(GeschaeftsfallTyp.BEREITSTELLUNG).buildAuftragWithSchaltungKupfer();
        Auftrag auftrag2 = new AuftragBuilder(GeschaeftsfallTyp.BEREITSTELLUNG).buildAuftragWithSchaltungKvz();
