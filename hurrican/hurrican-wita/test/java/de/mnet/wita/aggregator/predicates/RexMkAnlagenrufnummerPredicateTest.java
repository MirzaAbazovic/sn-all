...
public class RexMkAnlagenrufnummerPredicateTest extends BaseTest {

    private RexMkAnlagenrufnummerPredicate cut;

    @BeforeMethod
    public void setUp() {
        cut = new RexMkAnlagenrufnummerPredicate();
    }

    @DataProvider
    public Object[][] data() {
        Auftrag auftrag1 = new AuftragBuilder(GeschaeftsfallTyp.BEREITSTELLUNG).buildAuftragWithAnlagenrufnummer();
        Auftrag auftrag2 = new AuftragBuilder(GeschaeftsfallTyp.BEREITSTELLUNG).buildAuftragWithEinzelrufnummer(2);
        Auftrag auftrag3 = new AuftragBuilder(GeschaeftsfallTyp.BEREITSTELLUNG).buildAuftragWithEinzelrufnummer(1);
