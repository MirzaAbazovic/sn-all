...
public class RexMkMehrfachrufnummerPredicateTest extends BaseTest {

    private RexMkMehrfachrufnummerPredicate cut;

    @BeforeMethod
    public void setUp() {
        cut = new RexMkMehrfachrufnummerPredicate();
    }

    @DataProvider
    public Object[][] data() {
        Auftrag auftrag1 = new AuftragBuilder(GeschaeftsfallTyp.BEREITSTELLUNG).buildAuftragWithEinzelrufnummer(2);
        Auftrag auftrag2 = new AuftragBuilder(GeschaeftsfallTyp.BEREITSTELLUNG).buildAuftragWithEinzelrufnummer(1);
