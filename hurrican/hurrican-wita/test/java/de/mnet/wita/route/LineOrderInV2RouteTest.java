...
@Test(groups = UNIT)
public class LineOrderInV2RouteTest extends AbstractTestNGSpringContextTests {
    private static final String URI_IN_COMPONENT = "direct";
    private static final String URI_LINE_ORDER_SVC_V2 = "lineOrderServiceV2In";
    private static final String URI_ERROR_SVC_V1 = "errorServiceV1Out";

    @Produce(uri = URI_IN_COMPONENT + ":" + URI_LINE_ORDER_SVC_V2)
    ...
    private void setupCommonMockBehavior() throws Exception {
        ...
        when(routeConfigHelperMock.getLineOrderServiceV2In()).thenReturn(URI_LINE_ORDER_SVC_V2);
    ...
    private void loadAndStartCamelContext() throws Exception {
        ...
        springCamelContext.addRoutes(lineOrderInV2Route);
    ...
    private void successfullyProcessInboundMessage(boolean postProcessMessage, boolean simulateDuplicateVaRequest) throws Exception {
        ...
        verify(convertCdmV2ToWitaFormatProcessor).process(any(Exchange.class));
    ...
    public void inboundMessageCausesExceptionInMainRoute() throws Exception {
        ...
        modelCamelContext.getRouteDefinition(lineOrderInV2Route.getLineOrderInRouteId()).adviceWith(modelCamelContext, new RouteBuilder() {
            @Override
            public void configure() throws Exception {
                interceptSendToEndpoint(lineOrderInV2Route.getLineOrderInEmsTxUri()).skipSendToOriginalEndpoint().process(new Processor() {
                    @Override
