 ...
 * All rights reserved.
 * -------------------------------------------------------
 * File created: 30.03.2005 13:53:07
 */
...
import de.augustakom.hurrican.gui.hvt.HVTBestellungenFrame;


/**
 * Action, um eine Uebersicht mit der HVT-Bestellungen zu oeffnen.
 *
 *
 */
public class HVTBestellungAction extends AKAbstractOpenFrameAction {
    ...
    protected AKJInternalFrame getFrameToOpen() {
        HVTBestellungenFrame frame = new HVTBestellungenFrame();
