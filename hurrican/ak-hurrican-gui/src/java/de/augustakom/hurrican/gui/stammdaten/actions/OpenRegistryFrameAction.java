...
import de.augustakom.hurrican.gui.stammdaten.RegistryAdminFrame;


/**
 * Action, um das Admin-Frame fuer die Physik-Typen zu oeffnen.
 *
 *
 */
public class OpenRegistryFrameAction extends AKAbstractOpenFrameAction {
    ...
    public AKJInternalFrame getFrameToOpen() {
        RegistryAdminFrame frame = new RegistryAdminFrame();
