...
public class ImportVDSLGeoIdAction extends AbstractServiceAction implements GeoIdImportAction {

    protected final CommonImportGeoIdAction commonImportGeoIdAction;

    protected AvailabilityService availabilityService;

    public ImportVDSLGeoIdAction() throws Exception {
        ...
        commonImportGeoIdAction.CONFIRM_DIALOG_TITLE = "Import von Straßendaten für VDSL an HVT";
        commonImportGeoIdAction.FILE_CHOOSER_DIALOG_TITLE = "Import von Straßendaten für VDSL an HVT";
    ...
    public Map<String, Object> execute(String absolutePath) throws Exception {
        return availabilityService.importGeoIdsForVDSLAnHVT(absolutePath, HurricanSystemRegistry.instance().getSessionId());
    }
