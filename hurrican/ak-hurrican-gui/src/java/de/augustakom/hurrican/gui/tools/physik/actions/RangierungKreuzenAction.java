 ...
 * All rights reserved.
 * -------------------------------------------------------
 * File created: 13.07.2005 08:21:34
 */
...
import de.augustakom.hurrican.gui.tools.physik.RangierungKreuzenFrame;


/**
 * Action, um das Frame fuer die Rangierungs-Kreuzung zu oeffnen.
 *
 *
 */
public class RangierungKreuzenAction extends AKAbstractOpenFrameAction {
    ...
    protected AKJInternalFrame getFrameToOpen() {
        RangierungKreuzenFrame frame = new RangierungKreuzenFrame();
