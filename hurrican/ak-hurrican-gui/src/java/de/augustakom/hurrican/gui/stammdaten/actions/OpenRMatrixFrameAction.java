 ...
 * All rights reserved.
 * -------------------------------------------------------
 * File created: 12.11.2004 15:04:47
 */
...
import de.augustakom.hurrican.gui.stammdaten.RangierungsmatrixAdminFrame;


/**
 * Action, um das Rangierungsmatrix-Frame zu oeffnen.
 *
 *
 */
public class OpenRMatrixFrameAction extends AKAbstractOpenFrameAction {
    ...
    protected AKJInternalFrame getFrameToOpen() {
        RangierungsmatrixAdminFrame frame = new RangierungsmatrixAdminFrame();
