 ...
 */
public class RequestDetailStornoAufhebungAbgPanel extends AbstractRequestDetailPanel<StornoAufhebungAbgAnfrage> {
    ...
    public RequestDetailStornoAufhebungAbgPanel() {
        super("de/augustakom/hurrican/gui/tools/wbci/resources/RequestDetailStornoAufhebungAbgPanel.xml");
    }
