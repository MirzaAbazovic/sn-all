...
/**
 * Panel fuer die Darstellung einer HVT-Gruppe. <br> Dieses Panel wird ausserdem in dem Admin-Frame fuer die HVTs
 * verwendet!
 *
 *
 */
public class HVTGruppePanel extends AbstractServicePanel implements AKSimpleModelOwner, AKDataLoaderComponent {

    private static final Logger LOGGER = Logger.getLogger(HVTGruppePanel.class);
    ...
    private AKJCheckBox cbExport4Portal = null;
     ...
     * Konstruktor
     */
    public HVTGruppePanel(boolean enableGUI) {
        super("de/augustakom/hurrican/gui/hvt/resources/HVTGruppePanel.xml");
    ...
    protected final void createGUI() {
        ...
        AKJLabel lblExport4Portal = getSwingFactory().createLabel("hvt.gruppe.export4portal");
        ...
        cbExport4Portal = getSwingFactory().createCheckBox("hvt.gruppe.export4portal");
        ...
        hvtPanel.add(lblExport4Portal, GBCFactory.createGBC(0, 0, 0, 9, 1, 1, GridBagConstraints.HORIZONTAL));
        hvtPanel.add(cbExport4Portal, GBCFactory.createGBC(100, 0, 2, 9, 4, 1, GridBagConstraints.HORIZONTAL));
        ...
        this.add(hvtPanel, GBCFactory.createGBC(20, 0, 1, 0, 1, 1, GridBagConstraints.HORIZONTAL));
        this.add(new AKJPanel(), GBCFactory.createGBC(0, 0, 2, 0, 1, 1, GridBagConstraints.HORIZONTAL));
        this.add(tagePanel, GBCFactory.createGBC(20, 0, 3, 0, 1, 1, GridBagConstraints.BOTH));
    ...
    public void setModel(Observable model) {
        ...
        if (model != null) {
            ...
            cbExport4Portal.setSelected(hvtGruppe.getExport4Portal());
        }
        else {
            this.clear();
        }
    ...
    public Object getModel() {
        try {
            ...
            hvtGruppe.setExport4Portal(cbExport4Portal.isSelected());
    ...
    public final void loadData() {
        try {
            ...
            NiederlassungService service = getCCService(NiederlassungService.class);
            List<Niederlassung> niederlassung = service.findNiederlassungen();
            DefaultComboBoxModel cbModel = new DefaultComboBoxModel();
            cbNiederlassung.copyList2Model(niederlassung, cbModel);
