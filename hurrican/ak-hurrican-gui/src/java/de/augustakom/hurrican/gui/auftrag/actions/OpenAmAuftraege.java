 ...
 * All rights reserved.
 * -------------------------------------------------------
 * File created: 02.02.2005 10:54:48
 */
...
import de.augustakom.hurrican.gui.auftrag.views.AmAuftragsFrame;


/**
 * Action, um eine Liste mit allen unvollstaendigen Auftraegen anzuzeigen.
 *
 *
 */
public class OpenAmAuftraege extends AKAbstractOpenFrameAction {
    ...
    protected AKJInternalFrame getFrameToOpen() {
        AmAuftragsFrame frame = new AmAuftragsFrame();
