 ...
 * All rights reserved.
 * -------------------------------------------------------
 * File created: 14.06.2004 17:01:57
 */
...
import de.augustakom.hurrican.gui.auftrag.search.AuftragKundeSearchFrame;


/**
 * Action, um das Kunden-Suchfenster zu oeffnen.
 *
 *
 */
public class OpenAuftragSearchFrameAction extends AKAbstractOpenFrameAction {
    ...
    public AKJInternalFrame getFrameToOpen() {
        AuftragKundeSearchFrame frame = new AuftragKundeSearchFrame();
