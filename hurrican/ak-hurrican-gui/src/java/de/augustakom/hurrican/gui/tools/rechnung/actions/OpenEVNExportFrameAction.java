...
import de.augustakom.hurrican.gui.tools.rechnung.EVNExportFrame;


/**
 * Action, um die Maxi-Rechnungen zu exportieren.
 *
 *
 */
public class OpenEVNExportFrameAction extends AKAbstractOpenFrameAction {
    ...
    protected AKJInternalFrame getFrameToOpen() {
        EVNExportFrame frame = new EVNExportFrame();
