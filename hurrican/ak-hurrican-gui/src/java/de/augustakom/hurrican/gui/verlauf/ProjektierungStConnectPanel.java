...
/**
 * Projektierungs-Panel fuer die Darstellung/Bearbeitung der Projektierungen fuer die Abteilungen ST Connect.
 *
 *
 */
public class ProjektierungStConnectPanel extends AbstractProjektierungPanel {

    // GUI-Komponenten
    private AKJTextField tfBearbeiter = null;
    private AKJTextField tfStatus = null;

    public ProjektierungStConnectPanel() {
        super("de/augustakom/hurrican/gui/verlauf/resources/ProjektierungStConnectPanel.xml",
                Abteilung.ST_CONNECT, false, true);
        createGUI();
        super.loadData();
    }
