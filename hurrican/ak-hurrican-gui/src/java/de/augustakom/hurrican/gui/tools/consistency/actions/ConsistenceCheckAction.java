 ...
 * All rights reserved.
 * -------------------------------------------------------
 * File created: 27.07.2005 14:31:40
 */
package de.augustakom.hurrican.gui.tools.consistency.actions;
...
import de.augustakom.hurrican.gui.tools.consistency.ConsistenceCheckFrame;


/**
 * Action oeffnet ein Frame zur Konsistenz-Pruefung der Hurrican-Datenbank.
 *
 *
 */
public class ConsistenceCheckAction extends AKAbstractOpenFrameAction {
    ...
    protected AKJInternalFrame getFrameToOpen() {
        ConsistenceCheckFrame frame = new ConsistenceCheckFrame();
