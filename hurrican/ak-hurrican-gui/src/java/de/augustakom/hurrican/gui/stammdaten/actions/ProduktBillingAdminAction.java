 ...
 * All rights reserved.
 * -------------------------------------------------------
 * File created: 28.02.2006 11:26:56
 */
...
import de.augustakom.hurrican.gui.stammdaten.ProduktBillingAdminFrame;


/**
 * Action, um das Admin-Frame fuer die Verwaltung der Produkte aus dem Billinhg-System zu oeffnen.
 *
 *
 */
public class ProduktBillingAdminAction extends AKAbstractOpenFrameAction {
    ...
    protected AKJInternalFrame getFrameToOpen() {
        ProduktBillingAdminFrame frame = new ProduktBillingAdminFrame();
