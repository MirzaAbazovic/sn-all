 ...
 * All rights reserved.
 * -------------------------------------------------------
 * File created: 04.01.2006 16:06:52
 */
...
import de.augustakom.hurrican.gui.hvt.SearchRangierungFrame;

/**
 * Action, um das Frame fuer die Rangierungssuche zu oeffnen.
 *
 *
 */
public class OpenSearchRangierungFrameAction extends AKAbstractOpenFrameAction {
    ...
    protected AKJInternalFrame getFrameToOpen() {
        SearchRangierungFrame frame = new SearchRangierungFrame();
