...
import de.augustakom.hurrican.gui.tools.physik.RemoveRangierungFrame;


/**
 * Action, um das Frame fuer das Entfernen einer Rangierung zu oeffnen.
 *
 *
 */
public class RemoveRangierungAction extends AKAbstractOpenFrameAction {
    ...
    protected AKJInternalFrame getFrameToOpen() {
        RemoveRangierungFrame frame = new RemoveRangierungFrame();
