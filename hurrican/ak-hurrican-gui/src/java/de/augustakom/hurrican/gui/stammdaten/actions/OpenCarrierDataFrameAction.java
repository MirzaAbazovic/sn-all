...
import de.augustakom.hurrican.gui.stammdaten.CarrierDataAdminFrame;


/**
 * Action, um das Admin-Frame fuer die Carrier-Daten zu oeffnen.
 *
 *
 */
public class OpenCarrierDataFrameAction extends AKAbstractOpenFrameAction {
    ...
    public AKJInternalFrame getFrameToOpen() {
        CarrierDataAdminFrame frame = new CarrierDataAdminFrame();
