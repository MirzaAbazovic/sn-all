 ...
 * All rights reserved.
 * -------------------------------------------------------
 * File created: 12.08.2005 08:59:59
 */
package de.augustakom.hurrican.gui.tools.carrier.actions;
...
import de.augustakom.hurrican.gui.tools.carrier.LBZCheckDTAGFrame;


/**
 * Action, um das Frame fuer den LBZ-DTAG Check zu oeffnen.
 *
 *
 */
public class LBZCheckDTAGAction extends AKAbstractOpenFrameAction {
    ...
    protected AKJInternalFrame getFrameToOpen() {
        LBZCheckDTAGFrame frame = new LBZCheckDTAGFrame();
