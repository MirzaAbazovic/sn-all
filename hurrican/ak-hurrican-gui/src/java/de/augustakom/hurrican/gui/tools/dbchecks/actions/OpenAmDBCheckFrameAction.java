 ...
 * All rights reserved.
 * -------------------------------------------------------
 * File created: 23.09.2005 08:38:40
 */
package de.augustakom.hurrican.gui.tools.dbchecks.actions;
...
import de.augustakom.hurrican.gui.tools.dbchecks.AmDBCheckFrame;


/**
 * Action, um ein Frame fuer div. DB-Kontrollabfragen (fuer Abteilung AM) zu oeffnen.
 *
 *
 */
public class OpenAmDBCheckFrameAction extends AKAbstractOpenFrameAction {
    ...
    protected AKJInternalFrame getFrameToOpen() {
        AmDBCheckFrame frame = new AmDBCheckFrame();
