 ...
 * All rights reserved.
 * -------------------------------------------------------
 * File created: 23.09.2004 15:19:37
 */
...
import de.augustakom.hurrican.gui.auftrag.vpn.VPNVertragsUebersichtFrame;


/**
 * Action, um ein Frame mit Uebersicht aller VPN-Vertraege zu oeffnen.
 *
 *
 */
public class VPNUebersichtAction extends AKAbstractOpenFrameAction {
    ...
    protected AKJInternalFrame getFrameToOpen() {
        VPNVertragsUebersichtFrame frame = new VPNVertragsUebersichtFrame();
